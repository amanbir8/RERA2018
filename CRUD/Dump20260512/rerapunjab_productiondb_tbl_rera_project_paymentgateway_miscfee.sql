...
--
-- Table structure for table `tbl_rera_project_paymentgateway_miscfee`
--

DROP TABLE IF EXISTS `tbl_rera_project_paymentgateway_miscfee`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_project_paymentgateway_miscfee` (
  `PaymentRefNumberMiscProjectPm_IndexID` bigint(20) NOT NULL AUTO_INCREMENT,
  `PaymentRefNumberMiscProjectPm_ID` bigint(20) NOT NULL,
  ...
  `MiscFeeProject_Flag` varchar(50) NOT NULL,
  `MiscFeeProject_Code` bigint(20) NOT NULL,
  `User_ID` varchar(50) NOT NULL,
  `ProjectPmZoneType` varchar(50) NOT NULL,
  `PromoterType_IO` varchar(50) NOT NULL,
  `User_Name` varchar(100) NOT NULL,
  `MiscFeeProject_BriefSummary` varchar(250) DEFAULT NULL,
  ...
  PRIMARY KEY (`PaymentRefNumberMiscProjectPm_IndexID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_rera_project_paymentgateway_miscfee`
--

LOCK TABLES `tbl_rera_project_paymentgateway_miscfee` WRITE;
/*!40000 ALTER TABLE `tbl_rera_project_paymentgateway_miscfee` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_project_paymentgateway_miscfee` ENABLE KEYS */;
UNLOCK TABLES;
