...
--
-- Table structure for table `tbl_rera_complaint_formn_additionalemail`
--

DROP TABLE IF EXISTS `tbl_rera_complaint_formn_additionalemail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_complaint_formn_additionalemail` (
  `AdditionalEmailFormN_IndexID` bigint(20) NOT NULL AUTO_INCREMENT,
  `AdditionalEmailFormN_ID` bigint(20) NOT NULL,
  ...
  `ComplainantAppellant_Name` varchar(90) NOT NULL,
  ...
  PRIMARY KEY (`AdditionalEmailFormN_IndexID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_rera_complaint_formn_additionalemail`
--

LOCK TABLES `tbl_rera_complaint_formn_additionalemail` WRITE;
/*!40000 ALTER TABLE `tbl_rera_complaint_formn_additionalemail` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_complaint_formn_additionalemail` ENABLE KEYS */;
UNLOCK TABLES;
