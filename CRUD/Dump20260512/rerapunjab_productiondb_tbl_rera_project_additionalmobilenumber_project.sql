...
--
-- Table structure for table `tbl_rera_project_additionalmobilenumber_project`
--

DROP TABLE IF EXISTS `tbl_rera_project_additionalmobilenumber_project`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_project_additionalmobilenumber_project` (
  `AdditionalProjectMobileNumber_IndexID` bigint(20) NOT NULL AUTO_INCREMENT,
  `AdditionalProjectMobileNumber_ID` bigint(20) NOT NULL,
  ...
  PRIMARY KEY (`AdditionalProjectMobileNumber_IndexID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_rera_project_additionalmobilenumber_project`
--

LOCK TABLES `tbl_rera_project_additionalmobilenumber_project` WRITE;
/*!40000 ALTER TABLE `tbl_rera_project_additionalmobilenumber_project` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_project_additionalmobilenumber_project` ENABLE KEYS */;
UNLOCK TABLES;
