...
--
-- Table structure for table `tbl_rera_project_payment_miscfee`
--

DROP TABLE IF EXISTS `tbl_rera_project_payment_miscfee`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_project_payment_miscfee` (
  `ProjectPaymentMiscFee_IndexID` bigint(20) NOT NULL AUTO_INCREMENT,
  `ProjectPaymentMiscFee_ID` bigint(20) NOT NULL,
  ...
  PRIMARY KEY (`ProjectPaymentMiscFee_IndexID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_rera_project_payment_miscfee`
--

LOCK TABLES `tbl_rera_project_payment_miscfee` WRITE;
/*!40000 ALTER TABLE `tbl_rera_project_payment_miscfee` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_project_payment_miscfee` ENABLE KEYS */;
UNLOCK TABLES;
