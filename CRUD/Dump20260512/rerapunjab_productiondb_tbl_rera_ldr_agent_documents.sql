...
--
-- Table structure for table `tbl_rera_ldr_agent_documents`
--

DROP TABLE IF EXISTS `tbl_rera_ldr_agent_documents`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_ldr_agent_documents` (
...
--
-- Dumping data for table `tbl_rera_ldr_agent_documents`
--

LOCK TABLES `tbl_rera_ldr_agent_documents` WRITE;
/*!40000 ALTER TABLE `tbl_rera_ldr_agent_documents` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_ldr_agent_documents` ENABLE KEYS */;
UNLOCK TABLES;
