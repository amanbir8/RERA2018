...
--
-- Table structure for table `tbl_rera_ldr_project_reracertificate_completion`
--

DROP TABLE IF EXISTS `tbl_rera_ldr_project_reracertificate_completion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_ldr_project_reracertificate_completion` (
  `PCCProjectCertificate_IndexID` bigint(20) NOT NULL AUTO_INCREMENT,
  `PCCProjectCertificate_ID` bigint(20) NOT NULL,
  `RelatedProjectRegDiaryNumber_Name` varchar(90) NOT NULL,
  `RelatedCompletionProjectRegDiaryNumber_Name` varchar(90) NOT NULL,
  ...
  PRIMARY KEY (`PCCProjectCertificate_IndexID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_rera_ldr_project_reracertificate_completion`
--

LOCK TABLES `tbl_rera_ldr_project_reracertificate_completion` WRITE;
/*!40000 ALTER TABLE `tbl_rera_ldr_project_reracertificate_completion` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_ldr_project_reracertificate_completion` ENABLE KEYS */;
UNLOCK TABLES;
