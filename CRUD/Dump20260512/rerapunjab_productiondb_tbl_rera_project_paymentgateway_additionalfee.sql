...
--
-- Table structure for table `tbl_rera_project_paymentgateway_additionalfee`
--

DROP TABLE IF EXISTS `tbl_rera_project_paymentgateway_additionalfee`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_project_paymentgateway_additionalfee` (
  `PaymentRefNumberAdditionalProjectPm_IndexID` bigint(20) NOT NULL AUTO_INCREMENT,
  `PaymentRefNumberAdditionalProjectPm_ID` bigint(20) NOT NULL,
  `RelatedProject_ID` bigint(20) NOT NULL,
  `RelatedPromoter_ID` bigint(20) NOT NULL,
  `RelatedProject_Code` varchar(50) NOT NULL,
  `RelatedPromoter_Code` varchar(50) NOT NULL,
  `RelatedPayment_ID` bigint(20) NOT NULL,
  `RelatedPayment_IndexID` bigint(20) NOT NULL,
  `AdditionalFeeProject_Flag` varchar(50) NOT NULL,
  `AdditionalFeeProject_Code` bigint(20) NOT NULL,
  `User_ID` varchar(50) NOT NULL,
  `ProjectPmZoneType` varchar(50) NOT NULL,
  `PromoterType_IO` varchar(50) NOT NULL,
  `User_Name` varchar(100) NOT NULL,
  `AdditionalProject_BriefSummary` varchar(250) DEFAULT NULL,
  ...
  PRIMARY KEY (`PaymentRefNumberAdditionalProjectPm_IndexID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_rera_project_paymentgateway_additionalfee`
--

LOCK TABLES `tbl_rera_project_paymentgateway_additionalfee` WRITE;
/*!40000 ALTER TABLE `tbl_rera_project_paymentgateway_additionalfee` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_project_paymentgateway_additionalfee` ENABLE KEYS */;
UNLOCK TABLES;
