...
--
-- Table structure for table `tbl_rera_ecourt_complaint_formm_caseallocation`
--

DROP TABLE IF EXISTS `tbl_rera_ecourt_complaint_formm_caseallocation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_ecourt_complaint_formm_caseallocation` (
  `CaseAllocation_formM_eCourtIndexID` bigint(20) NOT NULL AUTO_INCREMENT,
  `CaseAllocation_formM_eCourtID` bigint(20) NOT NULL,
  ...
  `Related_CaseTransfer_IndexID` bigint(20) DEFAULT NULL,
  `Related_CaseTransfer_ID` bigint(20) DEFAULT NULL,
  `Related_PreHearingDate_IndexID` bigint(20) NOT NULL,
  `Related_PreHearingDate_ID` bigint(20) NOT NULL,
  `Related_OrderJudgementByAuthority_IndexID` bigint(20) DEFAULT NULL,
  `Related_OrderJudgementByAuthority_ID` bigint(20) DEFAULT NULL,
  ...
  PRIMARY KEY (`CaseAllocation_formM_eCourtIndexID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_rera_ecourt_complaint_formm_caseallocation`
--

LOCK TABLES `tbl_rera_ecourt_complaint_formm_caseallocation` WRITE;
/*!40000 ALTER TABLE `tbl_rera_ecourt_complaint_formm_caseallocation` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_ecourt_complaint_formm_caseallocation` ENABLE KEYS */;
UNLOCK TABLES;
