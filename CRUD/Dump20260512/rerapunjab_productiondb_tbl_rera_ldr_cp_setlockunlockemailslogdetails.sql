...
--
-- Table structure for table `tbl_rera_ldr_cp_setlockunlockemailslogdetails`
--

DROP TABLE IF EXISTS `tbl_rera_ldr_cp_setlockunlockemailslogdetails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_ldr_cp_setlockunlockemailslogdetails` (
...
--
-- Dumping data for table `tbl_rera_ldr_cp_setlockunlockemailslogdetails`
--

LOCK TABLES `tbl_rera_ldr_cp_setlockunlockemailslogdetails` WRITE;
/*!40000 ALTER TABLE `tbl_rera_ldr_cp_setlockunlockemailslogdetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_ldr_cp_setlockunlockemailslogdetails` ENABLE KEYS */;
UNLOCK TABLES;
