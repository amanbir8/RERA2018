...
--
-- Table structure for table `tbl_rera_rti_paymentgateway`
--

DROP TABLE IF EXISTS `tbl_rera_rti_paymentgateway`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_rti_paymentgateway` (
  `PaymentRefNumberRTI_IndexID` bigint(20) NOT NULL AUTO_INCREMENT,
  `PaymentRefNumberRTI_ID` bigint(20) NOT NULL,
  ...
  `IsAdditionalPaymentType` varchar(50) NOT NULL,
  `AdditionalPayment_Summary` varchar(50) NOT NULL,
  `RelatedAdditionalPayment_ID` bigint(20) NOT NULL,
  `RTIpayment_BriefSummary` varchar(250) DEFAULT NULL,
  ...
  PRIMARY KEY (`PaymentRefNumberRTI_IndexID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_rera_rti_paymentgateway`
--

LOCK TABLES `tbl_rera_rti_paymentgateway` WRITE;
/*!40000 ALTER TABLE `tbl_rera_rti_paymentgateway` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_rti_paymentgateway` ENABLE KEYS */;
UNLOCK TABLES;
