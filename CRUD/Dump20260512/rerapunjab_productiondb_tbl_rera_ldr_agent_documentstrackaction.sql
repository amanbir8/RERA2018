...
--
-- Table structure for table `tbl_rera_ldr_agent_documentstrackaction`
--

DROP TABLE IF EXISTS `tbl_rera_ldr_agent_documentstrackaction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_ldr_agent_documentstrackaction` (
...
--
-- Dumping data for table `tbl_rera_ldr_agent_documentstrackaction`
--

LOCK TABLES `tbl_rera_ldr_agent_documentstrackaction` WRITE;
/*!40000 ALTER TABLE `tbl_rera_ldr_agent_documentstrackaction` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_ldr_agent_documentstrackaction` ENABLE KEYS */;
UNLOCK TABLES;
