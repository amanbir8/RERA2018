...
--
-- Table structure for table `tbl_rera_agent_additionalmobilenumber_realestateagent`
--

DROP TABLE IF EXISTS `tbl_rera_agent_additionalmobilenumber_realestateagent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_agent_additionalmobilenumber_realestateagent` (
  `AdditionalAgentMobileNumber_IndexID` bigint(20) NOT NULL AUTO_INCREMENT,
  `AdditionalAgentMobileNumber_ID` bigint(20) NOT NULL,
  ...
  `LatestRenewalRegistrationNumber` varchar(60) NOT NULL,
  ...
  PRIMARY KEY (`AdditionalAgentMobileNumber_IndexID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_rera_agent_additionalmobilenumber_realestateagent`
--

LOCK TABLES `tbl_rera_agent_additionalmobilenumber_realestateagent` WRITE;
/*!40000 ALTER TABLE `tbl_rera_agent_additionalmobilenumber_realestateagent` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_agent_additionalmobilenumber_realestateagent` ENABLE KEYS */;
UNLOCK TABLES;
