...
--
-- Table structure for table `tbl_rera_complaint_formn_additioncomplainant_temp_bifurcation`
--

DROP TABLE IF EXISTS `tbl_rera_complaint_formn_additioncomplainant_temp_bifurcation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_complaint_formn_additioncomplainant_temp_bifurcation` (
...
--
-- Dumping data for table `tbl_rera_complaint_formn_additioncomplainant_temp_bifurcation`
--

LOCK TABLES `tbl_rera_complaint_formn_additioncomplainant_temp_bifurcation` WRITE;
/*!40000 ALTER TABLE `tbl_rera_complaint_formn_additioncomplainant_temp_bifurcation` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_complaint_formn_additioncomplainant_temp_bifurcation` ENABLE KEYS */;
UNLOCK TABLES;
