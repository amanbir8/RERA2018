...
--
-- Table structure for table `tbl_rera_complaint_formn_additionalmobilenumber`
--

DROP TABLE IF EXISTS `tbl_rera_complaint_formn_additionalmobilenumber`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_complaint_formn_additionalmobilenumber` (
  `AdditionalMobileNumberFormN_IndexID` bigint(20) NOT NULL AUTO_INCREMENT,
  `AdditionalMobileNumberFormN_ID` bigint(20) NOT NULL,
  ...
  PRIMARY KEY (`AdditionalMobileNumberFormN_IndexID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_rera_complaint_formn_additionalmobilenumber`
--

LOCK TABLES `tbl_rera_complaint_formn_additionalmobilenumber` WRITE;
/*!40000 ALTER TABLE `tbl_rera_complaint_formn_additionalmobilenumber` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_complaint_formn_additionalmobilenumber` ENABLE KEYS */;
UNLOCK TABLES;
