...
--
-- Table structure for table `tbl_rera_ldr_agent_profiletrackaction`
--

DROP TABLE IF EXISTS `tbl_rera_ldr_agent_profiletrackaction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_ldr_agent_profiletrackaction` (
...
--
-- Dumping data for table `tbl_rera_ldr_agent_profiletrackaction`
--

LOCK TABLES `tbl_rera_ldr_agent_profiletrackaction` WRITE;
/*!40000 ALTER TABLE `tbl_rera_ldr_agent_profiletrackaction` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_ldr_agent_profiletrackaction` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-12 10:58:38
