...
--
-- Table structure for table `tbl_rera_hdcr_project_projectfactsdetails`
--

DROP TABLE IF EXISTS `tbl_rera_hdcr_project_projectfactsdetails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_rera_hdcr_project_projectfactsdetails` (
  `ProjectPUC_ProjectFacts_IndexID` bigint(20) NOT NULL AUTO_INCREMENT,
  `ProjectPUC_ProjectFacts_ID` bigint(20) NOT NULL,
  ...
  PRIMARY KEY (`ProjectPUC_ProjectFacts_IndexID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_rera_hdcr_project_projectfactsdetails`
--

LOCK TABLES `tbl_rera_hdcr_project_projectfactsdetails` WRITE;
/*!40000 ALTER TABLE `tbl_rera_hdcr_project_projectfactsdetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_rera_hdcr_project_projectfactsdetails` ENABLE KEYS */;
UNLOCK TABLES;
