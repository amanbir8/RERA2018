...
{
    public class ClsPrp_JointPromoter_RegistrationDetails
    {
        ...
        public List<ClsPrp_JointPromoter_RegistrationDetails> prpjointpromoter { get; set; }
        public ClsPrp_JointPromoter_RegistrationDetails()
        {
            prpjointpromoter = new List<ClsPrp_JointPromoter_RegistrationDetails>();
        }
