...
{
    public class ClsMethod_RespondentComplaintFormM_Fee
    {
        ...
        public List<ClsPrp_RespondentComplaint_FormM_Fee> Display_ComplaintFormM_Payment_ForRespondentComplaint(Int64 ComplaintFormM_ID)
        {
            connection();
            List<ClsPrp_RespondentComplaint_FormM_Fee> ComplaintFormM_List = new List<ClsPrp_RespondentComplaint_FormM_Fee>();
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ComplaintFormM_List.Add(
                       new ClsPrp_RespondentComplaint_FormM_Fee
                       {
        ...
        public List<ClsPrp_RespondentComplaint_FormM_Fee> Display_ComplaintFormM_PaymentByPRN_ForRespondentComplaint(Int64 ComplaintFormM_PRNumber)
        {
            connection();
            List<ClsPrp_RespondentComplaint_FormM_Fee> ComplaintFormM_List = new List<ClsPrp_RespondentComplaint_FormM_Fee>();
