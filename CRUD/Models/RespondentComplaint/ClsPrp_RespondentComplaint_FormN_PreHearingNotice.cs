...
{
    public class ClsPrp_RespondentComplaint_FormN_PreHearingNotice
    {
        ...
        public List<ClsPrp_RespondentComplaint_FormN_PreHearingNotice> prpongoingNotice { get; set; }
        public ClsPrp_RespondentComplaint_FormN_PreHearingNotice()
        {
            prpongoingNotice = new List<ClsPrp_RespondentComplaint_FormN_PreHearingNotice>();

        }
        // //public List<ClsPrp_RespondentComplaint_PreHearingFixedFor_Master> PreHearingFixedForMaster { get; set; }
        // //public List<ClsPrp_RespondentComplaint_PreHearingBench_Master> PreHearingBenchMaster { get; set; }
