...
{
    public class ClsPrp_RespondentComplaint_FormN_DiaryNumber
    {
        ...
        public long FormN_RelatedComplaint_ID { get; set; }
        public string FormN_RelatedComplaint_Code { get; set; }
        ...
        public List<ClsPrp_RespondentComplaint_FormN_DiaryNumber> prpongoing { get; set; }
        public ClsPrp_RespondentComplaint_FormN_DiaryNumber()
        {
            prpongoing = new List<ClsPrp_RespondentComplaint_FormN_DiaryNumber>();
        }
        public List<Clsprp_RespondentComplaint_FormN_Documents> prpFormN_Docs { get; set; }
    }
}