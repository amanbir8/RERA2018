...
{
    public class ClsPrp_RespondentComplaint_FormM_PreHearingNotice
    {
        ...
        public List<ClsPrp_RespondentComplaint_FormM_PreHearingNotice> prpongoingNotice { get; set; }
        public ClsPrp_RespondentComplaint_FormM_PreHearingNotice()
        {
            prpongoingNotice = new List<ClsPrp_RespondentComplaint_FormM_PreHearingNotice>();
        }
