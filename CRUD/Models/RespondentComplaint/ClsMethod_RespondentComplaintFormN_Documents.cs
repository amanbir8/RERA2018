...
{
    public class ClsMethod_RespondentComplaintFormN_Documents
    {
        ...
        public List<Clsprp_RespondentComplaint_FormN_Documents> Display_ComplaintFormN_Documents_ByComplaintFormNID_ForRespondentComplaint(Int64? ComplaintFormN_ID)
        {
            connection();
            List<Clsprp_RespondentComplaint_FormN_Documents> ComplaintFormN_Documents = new List<Clsprp_RespondentComplaint_FormN_Documents>();
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ComplaintFormN_Documents.Add(
                    new Clsprp_RespondentComplaint_FormN_Documents
                    {
