...
{
    public class Clsprp_RespondentComplaint_FormM_Documents
    {
        ...
        public Clsprp_RespondentComplaint_FormM_Documents()
        {
            prpFormM_Docs = new List<Clsprp_RespondentComplaint_FormM_Documents>();
        }
    }
}