...
{
    public class ClsMethod_RespondentComplaintFormM_PreHearingNotice
    {
        ...
        public List<ClsPrp_RespondentComplaint_FormM_PreHearingNotice> Display_RespondentComplaintFormM_PreHearingNoticeByID(Int64 ComplaintFormM_ID, Int64 PreHearingNotice_ID)
        {
            connection();
            List<ClsPrp_RespondentComplaint_FormM_PreHearingNotice> ProjectFivelist1 = new List<ClsPrp_RespondentComplaint_FormM_PreHearingNotice>();
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ProjectFivelist1.Add(
                       new ClsPrp_RespondentComplaint_FormM_PreHearingNotice
                       {
