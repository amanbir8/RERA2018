...
{
    public class ClsPrp_RespondentComplaint_FormM_Registration
    {
        ...
        public ClsPrp_RespondentComplaint_FormM_Registration()
        {
            prpComplaintFormM = new List<ClsPrp_RespondentComplaint_FormM_Registration>();
        }
