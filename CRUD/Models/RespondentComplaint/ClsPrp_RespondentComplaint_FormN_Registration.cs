...
{
    public class ClsPrp_RespondentComplaint_FormN_Registration
    {
        ...
        public ClsPrp_RespondentComplaint_FormN_Registration()
        {
            prpComplaintFormN = new List<ClsPrp_RespondentComplaint_FormN_Registration>();
        }
