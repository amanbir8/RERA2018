...
{
    public class Clsprp_RespondentComplaint_FormN_Documents
    {
        ...
        public Clsprp_RespondentComplaint_FormN_Documents()
        {
            prpFormN_Docs = new List<Clsprp_RespondentComplaint_FormN_Documents>();
        }
    }
}