...
{
    public class ClsPrp_RespondentComplaint_FormM_Fee
    {
        ...
        public List<ClsPrp_RespondentComplaint_FormM_Fee> prpComplaintFormM_Fee { get; set; }
        public ClsPrp_RespondentComplaint_FormM_Fee()
        {
            prpComplaintFormM_Fee = new List<ClsPrp_RespondentComplaint_FormM_Fee>();
        }

        public List<ClsPrp_RespondentComplaint_FormM_Registration> prpComplaintFormM { get; set; }
    }
}