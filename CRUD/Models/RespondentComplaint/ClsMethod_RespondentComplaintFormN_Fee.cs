...
{
    public class ClsMethod_RespondentComplaintFormN_Fee
    {
        ...
        public List<ClsPrp_RespondentComplaint_FormN_Fee> Display_ComplaintFormN_Payment_ForRespondentComplaint(Int64 ComplaintFormN_ID)
        {
            connection();
            List<ClsPrp_RespondentComplaint_FormN_Fee> ComplaintFormN_List = new List<ClsPrp_RespondentComplaint_FormN_Fee>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_FormN_Fee_ForDesk", con);
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ComplaintFormN_List.Add(
                       new ClsPrp_RespondentComplaint_FormN_Fee
                       {
        ...
        public List<ClsPrp_RespondentComplaint_FormN_Fee> Display_ComplaintFormN_PaymentByPRN_ForRespondentComplaint(Int64 ComplaintFormN_PRNumber)
        {
            connection();
            List<ClsPrp_RespondentComplaint_FormN_Fee> ComplaintFormN_List = new List<ClsPrp_RespondentComplaint_FormN_Fee>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_FormN_FeeByPRN_ForDesk", con);
            cmd.CommandType = CommandType.StoredProcedure;
