...
{
    public class Clsprp_Master_Execution_Documents
    {
        ...
        public List<Clsprp_Master_Execution_Documents> prpMasterDocs { get; set; }
        public Clsprp_Master_Execution_Documents()
        {
            prpMasterDocs = new List<Clsprp_Master_Execution_Documents>();
        }
    }
}