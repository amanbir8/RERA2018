...
{
    public class ClsPrp_Print_ExecutionForm_Registration
    {
        ...
        public List<Clsprp_ExecutionForm_Documents> prpComplaintFormM_Docs { get; set; }
        public List<ClsPrp_Print_ExecutionForm_Registration> ExecutionFormstepI { get; set; }
        public ClsPrp_Print_ExecutionForm_Registration()
        {
            ExecutionFormstepI = new List<ClsPrp_Print_ExecutionForm_Registration>();
        }
        ...
        public List<ClsPrp_Print_FormExe_AddMore_Complainant> prpComplaintFormExe_AddMoreComplainant { get; set; }
        public List<ClsPrp_Print_FormExe_AddMore_Respondent> prpComplaintFormExe_AddMoreRespondent { get; set; }
    }
}