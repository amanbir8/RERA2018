...
{
    public class Clsprp_MIS_RenewalAgentAddressDirectoryDetails
    {
        ...
        public List<Clsprp_MIS_RenewalAgentAddressDirectoryDetails> prpongoing { get; set; }
        public Clsprp_MIS_RenewalAgentAddressDirectoryDetails()
        {
            prpongoing = new List<Clsprp_MIS_RenewalAgentAddressDirectoryDetails>();
        }
