...
{
    public class Clsprp_MIS_AgentAddressDirectoryExportExcel
    {
        ...
        public DateTime? RenewalApplication_Date { get; set; }
        ...
        public List<Clsprp_MIS_AgentAddressDirectoryExportExcel> prpongoing { get; set; }
        public Clsprp_MIS_AgentAddressDirectoryExportExcel()
        {
            prpongoing = new List<Clsprp_MIS_AgentAddressDirectoryExportExcel>();
        }
