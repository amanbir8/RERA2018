...
{
    public class Clsprp_MIS_RenewalAgentQRcodeCertificateDetails
    {
        ...
        public string Reference_DiaryNumber { get; set; }

        public long Agent_ID { get; set; }
        public int Agent_Type { get; set; }
        public long RenewalAgent_ID { get; set; }
        public int RenewalAgent_SequenceID { get; set; }
        public int RenewalAgent_YearID { get; set; }
        ...
        [StringLength(50, MinimumLength = 4)]
        public string RERA_RenewalRegistrationNumber { get; set; }

        [Display(Name = "Renewal of Registration Issue Date")]
        [DisplayFormat(DataFormatString = "{0:dd-MMM-yyyy}", ApplyFormatInEditMode = true)]
        public DateTime? RERA_RenewalRegistrationNumber_IssueDate { get; set; }

        [Display(Name = "Renewal of Registration Upto Date")]
        [DisplayFormat(DataFormatString = "{0:dd-MMM-yyyy}", ApplyFormatInEditMode = true)]
        public DateTime? RERA_RenewalRegistrationNumber_ValidUptoDate { get; set; }
        ...
        [Display(Name = "Renewal of Registration Renewal Date")]
        [DisplayFormat(DataFormatString = "{0:dd-MMM-yyyy}", ApplyFormatInEditMode = true)]
        public DateTime? RERA_RenewalRegistrationNumber_RenewalDate { get; set; }

        public List<Clsprp_MIS_RenewalAgentQRcodeCertificateDetails> prpongoing { get; set; }
        public Clsprp_MIS_RenewalAgentQRcodeCertificateDetails()
        {
            prpongoing = new List<Clsprp_MIS_RenewalAgentQRcodeCertificateDetails>();
        }
