...
{
    public class Clsprp_MIS_RenewalAgentQRcodeCertificateExportExcel
    {
        ...
        public List<Clsprp_MIS_RenewalAgentQRcodeCertificateExportExcel> prpongoing { get; set; }
        public Clsprp_MIS_RenewalAgentQRcodeCertificateExportExcel()
        {
            prpongoing = new List<Clsprp_MIS_RenewalAgentQRcodeCertificateExportExcel>();
        }
