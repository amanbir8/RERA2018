...
{
    public class ClsprpMIS_AgentInCompleteRemindersSchedulerEmails
    {
        public long AgentReminder_IndexID { get; set; }
        public long AgentReminder_ID { get; set; }
        ...
        public List<ClsprpMIS_AgentInCompleteRemindersSchedulerEmails> prpongoing { get; set; }
        public ClsprpMIS_AgentInCompleteRemindersSchedulerEmails()
        {
            prpongoing = new List<ClsprpMIS_AgentInCompleteRemindersSchedulerEmails>();
        }
        
        public List<ClsprpMIS_AgentInCompleteRemindersSchedulerSMSgateway> prpSchedulerSMSgateway { get; set; }
    }
}