...
{
    public class ClsMethodMIS_AgentReminderSMSsDetails
    {
        ...
        public List<ClsprpMIS_AgentInCompleteRemindersSchedulerSMSgateway> Display_AuthDesk_MIS_AgentSchedulerReminderSMSsDetails_ForAgents(Int64 Agent_ID, Int64 Code_ID, string Agent_DNumber, string UserID_Role)
        {
            connection();
            List<ClsprpMIS_AgentInCompleteRemindersSchedulerSMSgateway> AgentReralist = new List<ClsprpMIS_AgentInCompleteRemindersSchedulerSMSgateway>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_MIS_AgentReminderSMSsSchedulerDetails_Agents", con);
            ...
            {
                AgentReralist.Add(
                       new ClsprpMIS_AgentInCompleteRemindersSchedulerSMSgateway
                       {
                           AgentReminderSMS_IndexID = Convert.ToInt64(dr["AgentReminderSMS_IndexID"]),
                           AgentReminderSMS_ID = Convert.ToInt64(dr["AgentReminderSMS_ID"]),
