...
namespace CRUD.Models.DataAnalysisPanel
{
    public class ClsPrp_AnalysisReportingPanel_View_InfoDesk
    {
        ...
        public List<ClsPrp_AnalysisReportingPanel_View_InfoDesk> prpongoing { get; set; }
        public ClsPrp_AnalysisReportingPanel_View_InfoDesk()
        {
            prpongoing = new List<ClsPrp_AnalysisReportingPanel_View_InfoDesk>();
        }        
    }
}