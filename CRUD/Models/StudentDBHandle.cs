...
namespace CRUD.Models
{
    public class StudentDBHandle
    {
        ...
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("AddNewStudent", con);
        ...
        public List<StudentModel> GetStudent()
        {
            ...
            MySqlCommand cmd = new MySqlCommand("GetStudentDetails", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("UpdateStudentDetails", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("DeleteStudent", con);
            cmd.CommandType = CommandType.StoredProcedure;
