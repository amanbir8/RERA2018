...
{
    public class ClsPrp_Print_AgentPayment
    {
        ...
        public List<ClsPrp_Print_AgentPayment> AgentPayment { get; set; }
        public ClsPrp_Print_AgentPayment()
        {
            AgentPayment = new List<ClsPrp_Print_AgentPayment>();
        }

        //public List<ClsPrp_Master_BankDetails> BankMaster { get; set; }
        //public List<ClsPrp_Master_PaymentType> PayFeeMaster { get; set; }

        public List<ClsPrp_Print_AgentPaymentIntegration> AgentPaymentWithTranasactions { get; set; }
    }
}