...
{
    public class ClsPrp_Print_AgentOtherIndProfile
    {
        ...
        public List<ClsPrp_Print_AgentOtherIndProfile> AgentOtherIndProfile { get; set; }
        public ClsPrp_Print_AgentOtherIndProfile()
        {
            AgentOtherIndProfile = new List<ClsPrp_Print_AgentOtherIndProfile>();
        }
