...
{
    public class ClsPrp_Print_AgentOtherStateUT_RERA
    {
        ...
        public List<ClsPrp_Print_AgentOtherStateUT_RERA> Agent_OtherStateUTMember { get; set; }

        public ClsPrp_Print_AgentOtherStateUT_RERA()
        {
            Agent_OtherStateUTMember = new List<ClsPrp_Print_AgentOtherStateUT_RERA>();
        }        
    }
}