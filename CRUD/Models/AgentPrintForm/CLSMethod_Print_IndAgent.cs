...
{
    public class CLSMethod_Print_IndAgent
    {
        ...
        public List<Clsprp_IndAgent> Display_Print_AgentIndProfileDetail(Int64 Agent_ID)
        {
            connection();
            ...
            List<Clsprp_IndAgent> list_indPro = new List<Clsprp_IndAgent>();
        ...
        public List<ClsPrp_Print_RenewalAgent_IndividualProfile> Display_Print_RenewalAgent_IndividualProfileDetail(Int64 Agent_ID, Int32 TypeOfAgent_ID, Int64 RenewalAgent_ID, Int32 RenewalAgent_SequenceID, Int32 RenewalAgent_Year, string UserID_Role)
        {
            List<ClsPrp_Print_RenewalAgent_IndividualProfile> list_indPro = new List<ClsPrp_Print_RenewalAgent_IndividualProfile>();
            ...
            foreach (DataRow dr in dt.Rows)
            {
                if (Convert.ToInt32(dr["Related_Agent_Type"]) == 1)
                {
                    list_indPro.Add(
                        new ClsPrp_Print_RenewalAgent_IndividualProfile
                        {
