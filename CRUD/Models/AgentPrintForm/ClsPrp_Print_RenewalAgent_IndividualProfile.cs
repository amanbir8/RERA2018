...
{
    public class ClsPrp_Print_RenewalAgent_IndividualProfile
    {
        ...
        public List<ClsPrp_Print_RenewalAgent_IndividualProfile> AgentIndividual { get; set; }
        public ClsPrp_Print_RenewalAgent_IndividualProfile()
        {
            AgentIndividual = new List<ClsPrp_Print_RenewalAgent_IndividualProfile>();
        }
