...
{
    public class ClsPrp_Print_RenewalAgent_PaymentIntegration
    {
        ...
        public ClsPrp_Print_RenewalAgent_PaymentIntegration()
        {
            AgentRenewalPaymentWithTranasactions = new List<ClsPrp_Print_RenewalAgent_PaymentIntegration>();
        }
