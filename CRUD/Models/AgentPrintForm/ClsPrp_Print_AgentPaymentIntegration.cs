...
{
    public class ClsPrp_Print_AgentPaymentIntegration
    {
        ...
        public List<ClsPrp_Print_AgentPaymentIntegration> AgentPaymentTranasactions { get; set; }
        public ClsPrp_Print_AgentPaymentIntegration()
        {
            AgentPaymentTranasactions = new List<ClsPrp_Print_AgentPaymentIntegration>();
        }
