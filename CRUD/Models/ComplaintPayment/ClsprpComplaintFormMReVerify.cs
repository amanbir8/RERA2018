...
namespace CRUD.Models.ComplaintPayment
{
    public class ClsprpComplaintFormMReVerify
    {
        ...
        public List<ClsprpComplaintFormMReVerify> ComplaintFormMList { get; set; }
        public ClsprpComplaintFormMReVerify()
        {
            ComplaintFormMList = new List<ClsprpComplaintFormMReVerify>();
        }
    }
}