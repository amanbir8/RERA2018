...
{
    public class ClsPrp_ComplaintFormM_PaymentIntegration
    {
        ...
        public List<ClsPrp_ComplaintFormM_PaymentIntegration> ComplaintFormMstepII { get; set; }
        public ClsPrp_ComplaintFormM_PaymentIntegration()
        {
            ComplaintFormMstepII = new List<ClsPrp_ComplaintFormM_PaymentIntegration>();
        }
        ...
        public List<ClsPrp_ComplaintFormM_Registration> ComplaintFormM_ApplicationStepI { get; set; }
