...
{
    public class ClsPrp_ComplaintFormN_PaymentIntegration
    {
        ...
        public List<ClsPrp_ComplaintFormN_PaymentIntegration> ComplaintFormNstepII { get; set; }
        public ClsPrp_ComplaintFormN_PaymentIntegration()
        {
            ComplaintFormNstepII = new List<ClsPrp_ComplaintFormN_PaymentIntegration>();
        }
        ...
        public List<ClsPrp_ComplaintFormN_Registration> ComplaintFormN_ApplicationStepI { get; set; }
        public List<ClsPrp_ComplaintProfile> ComplainantFormN_UserProfile { get; set; }
    }
}