...
{
    public class ClsPrp_AdminDesk_OrderJudgementByAO
    {
        ...
        public List<ClsPrp_AdminDesk_OrderJudgementByAO> prpOrderJudgementByAO { get; set; }
        public ClsPrp_AdminDesk_OrderJudgementByAO()
        {
            prpOrderJudgementByAO = new List<ClsPrp_AdminDesk_OrderJudgementByAO>();
        } 
