...
{
    public class ClsPrp_AdminDesk_ReatCircularPublicNotice
    {
        ...
        public List<ClsPrp_AdminDesk_ReatCircularPublicNotice> prpreatCircularPublicNotice { get; set; }
        public ClsPrp_AdminDesk_ReatCircularPublicNotice()
        {
            prpreatCircularPublicNotice = new List<ClsPrp_AdminDesk_ReatCircularPublicNotice>();
        }
