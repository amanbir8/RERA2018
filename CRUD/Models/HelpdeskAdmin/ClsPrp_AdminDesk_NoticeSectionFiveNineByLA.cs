...
{
    public class ClsPrp_AdminDesk_NoticeSectionFiveNineByLA
    {
        ...
        public List<ClsPrp_AdminDesk_NoticeSectionFiveNineByLA> prpNoticeSectionFiveNineByLA { get; set; }
        public ClsPrp_AdminDesk_NoticeSectionFiveNineByLA()
        {
            prpNoticeSectionFiveNineByLA = new List<ClsPrp_AdminDesk_NoticeSectionFiveNineByLA>();
        }

        public List<ClsPrp_MasterAdminDesk_NoticeSectionFiveNineByLA_EventActionDetails> EventMaster { get; set; }
        public List<ClsPrp_MasterAdminDesk_NoticeSectionFiveNineByLA_DeskActionDetails> DeskMaster { get; set; }
        public List<ClsPrp_MasterAdminDesk_PreHearingBenchSectionFiveNine_Master> PreHearingBenchMaster { get; set; }
