...
{
    public class ClsprpMIS_ExtnFormProjectInCompleteRemindersSchedulerSMSgateway
    {
        public long ExtnProjectReminderSMS_IndexID { get; set; }
        public long ExtnProjectReminderSMS_ID { get; set; }
        ...
        public List<ClsprpMIS_ExtnFormProjectInCompleteRemindersSchedulerSMSgateway> prpongoing { get; set; }
        public ClsprpMIS_ExtnFormProjectInCompleteRemindersSchedulerSMSgateway()
        {
            prpongoing = new List<ClsprpMIS_ExtnFormProjectInCompleteRemindersSchedulerSMSgateway>();
        }
    }
}