...
{
    public class ClsMethodMIS_ExtnFormProjectReminderEmailsDetails
    {
        ...
        public List<ClsprpMIS_ExtnFormProjectInCompleteRemindersSchedulerEmails> Display_AuthDesk_MIS_ExtnFormProjectSchedulerReminderEmailsDetails_ForProjects(Int64 Project_ID, Int64 Promoter_ID, string ExtnForm_DNumber, string UserID_Role)
        {
            connection();
            List<ClsprpMIS_ExtnFormProjectInCompleteRemindersSchedulerEmails> ProjectReralist = new List<ClsprpMIS_ExtnFormProjectInCompleteRemindersSchedulerEmails>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_MIS_ExtnFormReminderEmailSchedulerDetails_Projects", con);
            ...
            {
                ProjectReralist.Add(
                       new ClsprpMIS_ExtnFormProjectInCompleteRemindersSchedulerEmails
                       {
                           ExtnProjectReminder_IndexID = Convert.ToInt64(dr["ExtnProjectReminder_IndexID"]),
                           ExtnProjectReminder_ID = Convert.ToInt64(dr["ExtnProjectReminder_ID"]),
