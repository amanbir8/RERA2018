...
{
    public class ClsprpMIS_ProjectStatementofAccountsFormFive
    {
        ...
        public List<ClsprpMIS_ProjectStatementofAccountsFormFive> prpongoing { get; set; }
        public ClsprpMIS_ProjectStatementofAccountsFormFive()
        {
            prpongoing = new List<ClsprpMIS_ProjectStatementofAccountsFormFive>();
        }
    }
}