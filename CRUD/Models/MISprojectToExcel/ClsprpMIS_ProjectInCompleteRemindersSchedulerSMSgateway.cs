...
{
    public class ClsprpMIS_ProjectInCompleteRemindersSchedulerSMSgateway
    {
        ...
        public List<ClsprpMIS_ProjectInCompleteRemindersSchedulerSMSgateway> prpongoing { get; set; }
        public ClsprpMIS_ProjectInCompleteRemindersSchedulerSMSgateway()
        {
            prpongoing = new List<ClsprpMIS_ProjectInCompleteRemindersSchedulerSMSgateway>();
        }
    }
}