...
{
    public class ClsprpMIS_ExtnFormProjectInCompleteRemindersSchedulerEmails
    {
        public long ExtnProjectReminder_IndexID { get; set; }
        public long ExtnProjectReminder_ID { get; set; }
        public long Project_ID { get; set; }
        public long Promoter_ID { get; set; }
        public long ExtnProject_ID { get; set; }
        ...
        [Display(Name = "ExtensionForm Diary Number")]
        public string ExtnProject_DiaryNumber { get; set; }
        ...
        public List<ClsprpMIS_ExtnFormProjectInCompleteRemindersSchedulerEmails> prpongoing { get; set; }
        public ClsprpMIS_ExtnFormProjectInCompleteRemindersSchedulerEmails()
        {
            prpongoing = new List<ClsprpMIS_ExtnFormProjectInCompleteRemindersSchedulerEmails>();
        }
        
        public List<ClsprpMIS_ExtnFormProjectInCompleteRemindersSchedulerSMSgateway> prpSchedulerSMSgateway { get; set; }
    }
}