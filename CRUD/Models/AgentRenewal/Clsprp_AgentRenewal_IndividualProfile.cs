...
{
    public class Clsprp_AgentRenewal_IndividualProfile
    {
        ...
        public List<Clsprp_AgentRenewal_IndividualProfile> AgentRenewal_IndProfile { get; set; }
        public Clsprp_AgentRenewal_IndividualProfile()
        {
            AgentRenewal_IndProfile = new List<Clsprp_AgentRenewal_IndividualProfile>();
        }
    }
}