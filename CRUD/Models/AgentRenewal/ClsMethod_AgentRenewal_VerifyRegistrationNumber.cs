...
{
    public class ClsMethod_AgentRenewal_VerifyRegistrationNumber
    {
        ...
        public List<Clsprp_AgentRenewal_VerifyPreviousRegistration> Display_AgentRenewal_VerifyRegistrationNumberByID(string RegNumber, DateTime RegFromDate, DateTime RegToDate, Int64 Index_ID, Int64 Key_ID, Int64 Agent_ID, Int32 TypeOfAgent_ID, string UserNam)
        {
            connection();
            List<Clsprp_AgentRenewal_VerifyPreviousRegistration> AgentRenewalparameters = new List<Clsprp_AgentRenewal_VerifyPreviousRegistration>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_AgentRenewal_VerifyRegistrationNumberByID", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("p_Index_ID", Index_ID);
            cmd.Parameters.AddWithValue("p_Key_ID", Key_ID);
            cmd.Parameters.AddWithValue("p_Agent_ID", Agent_ID);
            cmd.Parameters.AddWithValue("p_TypeOfAgent_ID", TypeOfAgent_ID);
            cmd.Parameters.AddWithValue("p_RegNumber", RegNumber);
            cmd.Parameters.AddWithValue("p_RegFromDate", RegFromDate);
            cmd.Parameters.AddWithValue("p_RegToDate", RegToDate);
            ...
            {
                AgentRenewalparameters.Add(
                       new Clsprp_AgentRenewal_VerifyPreviousRegistration
                       {
                           AgentRenewal_VerifyPreviousRegistration_IndexID = Convert.ToInt64(dr["AgentRenewal_VerifyPreviousRegistration_IndexID"]),
                           AgentRenewal_VerifyPreviousRegistration_ID = Convert.ToInt64(dr["AgentRenewal_VerifyPreviousRegistration_ID"]),
                           ...
                           Agent_RegDiaryNumber_Name = Convert.ToString(dr["Agent_RegDiaryNumber_Name"]),
                           Agent_RegDiaryNumber_Year = Convert.ToInt64(dr["Agent_RegDiaryNumber_Year"]),
                           Agent_RegDiaryNumber_Application_Date = Convert.ToDateTime(dr["Agent_RegDiaryNumber_Application_Date"]),

                           Agent_LDR_RERAnumber_DiaryNumber_ID = Convert.ToInt64(dr["Agent_LDR_RERAnumber_DiaryNumber_ID"]),
                           Is_YesNo_AgentRegistered_Flag = Convert.ToInt32(dr["Is_YesNo_AgentRegistered_Flag"]),
                           ...
                           Agent_PlaceOfBussiness_AddressLine1 = Convert.ToString(dr["Agent_PlaceOfBussiness_AddressLine1"]),
                           Agent_PlaceOfBussiness_AddressLine2 = Convert.ToString(dr["Agent_PlaceOfBussiness_AddressLine2"]),
                           Agent_PlaceOfBussiness_District = Convert.ToString(dr["Agent_PlaceOfBussiness_District"]),
                           Agent_PlaceOfBussiness_State = Convert.ToString(dr["Agent_PlaceOfBussiness_State"]),
                           Agent_PlaceOfBussiness_PIN = Convert.ToString(dr["Agent_PlaceOfBussiness_PIN"]),
                           Agent_Email_Address = Convert.ToString(dr["Agent_Email_Address"]),
                           Agent_Mobile_PhoneNumber = Convert.ToInt64(dr["Agent_Mobile_PhoneNumber"]),

                           Is_YesNo_AgentDescription_Flag = Convert.ToInt32(dr["Is_YesNo_AgentDescription_Flag"]),
                           ...
                           Renewal_OrderSequence = Convert.ToInt32(dr["Renewal_OrderSequence"]),
                           Renewal_OrderSequence_Name = Convert.ToString(dr["Renewal_OrderSequence_Name"]),
                           Related_RenewalAgentRegDiaryNumber_Name = Convert.ToString(dr["Related_RenewalAgentRegDiaryNumber_Name"]),
                           Related_RenewalAgentRegDiaryNumber_Year = Convert.ToInt32(dr["Related_RenewalAgentRegDiaryNumber_Year"]),
                           Related_RenewalAgentRegDiaryNumber_Application_Date = Convert.ToDateTime(dr["Related_RenewalAgentRegDiaryNumber_Application_Date"]),
                           ...
                           Agent_LDR_RenewalRERAnumber_DiaryNumber_ID = Convert.ToInt64(dr["Agent_LDR_RenewalRERAnumber_DiaryNumber_ID"]),
                           Is_YesNo_ActiveProvider_Flag = Convert.ToInt32(dr["Is_YesNo_ActiveProvider_Flag"]),
                           Is_YesNo_RenewalAgentRegistered_Flag = Convert.ToInt32(dr["Is_YesNo_RenewalAgentRegistered_Flag"]),

                           // Offline Agent Registered Number
                           OfflineAgentRegistrationNumber = Convert.ToString(dr["OfflineAgentRegistrationNumber"]),
                           OfflineAgentRegistrationIssueDate = Convert.ToDateTime(dr["OfflineAgentRegistrationIssueDate"]),
                           OfflineAgentRegistrationRegUptoDate = Convert.ToDateTime(dr["OfflineAgentRegistrationRegUptoDate"]),

                           ProfileNewCreated_Agent_ID = Convert.ToInt64(dr["ProfileNewCreated_Agent_ID"]),

                           Is_YesNo_ProfileNewCreated_Flag = Convert.ToInt32(dr["Is_YesNo_ProfileNewCreated_Flag"]),
                           Is_YesNo_OfflineAgentRegistered_Flag = Convert.ToInt32(dr["Is_YesNo_OfflineAgentRegistered_Flag"]),

                           // Agent Renewal Permission Flag
                           Is_YesNo_AgentRenewalPermission_Flag = Convert.ToInt32(dr["Is_YesNo_AgentRenewalPermission_Flag"]),
                           Is_YesNo_ValidforAgentRenewal_Flag = Convert.ToInt32(dr["Is_YesNo_ValidforAgentRenewal_Flag"]),
            ...
            return AgentRenewalparameters;
        }

        public List<Clsprp_AgentRenewal_StepPreviousRegistration> Display_AgentRenewal_StepPreviousRegistrationByID(Int64 Agent_ID, Int32 TypeOfAgent_ID, Int64 Key_ID, string OtherMember_YN, string OtherRERA_YN, string UserNam)
        {
            connection();
            List<Clsprp_AgentRenewal_StepPreviousRegistration> AgentRenewalparameters = new List<Clsprp_AgentRenewal_StepPreviousRegistration>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_AgentRenewal_StepPreviousRegistrationByID", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("p_Agent_ID", Agent_ID);
            cmd.Parameters.AddWithValue("p_TypeOfAgent_ID", TypeOfAgent_ID);
            cmd.Parameters.AddWithValue("p_Key_ID", Key_ID);
            cmd.Parameters.AddWithValue("p_OtherMember_YN", OtherMember_YN);
            cmd.Parameters.AddWithValue("p_OtherRERA_YN", OtherRERA_YN);
            cmd.Parameters.AddWithValue("p_UserNam", UserNam);
            MySqlDataAdapter sd = new MySqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            ...
            {
                AgentRenewalparameters.Add(
                       new Clsprp_AgentRenewal_StepPreviousRegistration
                       {
                           AgentRenewal_StepPreviousRegistration_IndexID = Convert.ToInt64(dr["AgentRenewal_StepPreviousRegistration_IndexID"]),
                           AgentRenewal_StepPreviousRegistration_ID = Convert.ToInt64(dr["AgentRenewal_StepPreviousRegistration_ID"]),

                           RERAnumberRegistration = Convert.ToString(dr["RERAnumberRegistration"]),

                           Agent_ID = Convert.ToInt64(dr["Agent_ID"]),
                           Agent_Type = Convert.ToInt32(dr["Agent_Type"]),
                           Is_YesNo_AgentID_Flag = Convert.ToInt32(dr["Is_YesNo_AgentID_Flag"]),

                           Related_RenewalAgent_ID = Convert.ToInt64(dr["Related_RenewalAgent_ID"]),
                           Related_RenewalAgent_Year = Convert.ToInt32(dr["Related_RenewalAgent_Year"]),
                           Renewal_OrderSequence = Convert.ToInt32(dr["Renewal_OrderSequence"]),
                           Renewal_OrderSequence_Name = Convert.ToString(dr["Renewal_OrderSequence_Name"]),
                           Is_YesNo_RenewalAgentID_Flag = Convert.ToInt32(dr["Is_YesNo_RenewalAgentID_Flag"]),
                           Is_YesNo_RenewalAgentRegistered_Flag = Convert.ToInt32(dr["Is_YesNo_RenewalAgentRegistered_Flag"]),

                           Is_YesNo_RenewalAgent_OtherMembers = Convert.ToInt32(dr["Is_YesNo_RenewalAgent_OtherMembers"]),
                           Is_YesNo_RenewalAgent_OtherStateUTnumber = Convert.ToInt32(dr["Is_YesNo_RenewalAgent_OtherStateUTnumber"]),
        ...
        public List<Clsprp_AgentRenewal_ListPreviousRegistrations> Display_AgentRenewal_ListPreviousRegistrationByID(Int64 Agent_ID, Int32 TypeOfAgent_ID, Int64 RenewalAgent_ID, Int32 RenewalAgent_Sequence, Int32 RenewalAgent_Year, string RERARefNumber, Int32 Key_ID, Int32 Key_SubID, string UserNam)
        {
            connection();
            List<Clsprp_AgentRenewal_ListPreviousRegistrations> AgentRenewalList = new List<Clsprp_AgentRenewal_ListPreviousRegistrations>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_AgentRenewal_ListPreviousRegistrationByID", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("p_Agent_ID", Agent_ID);
            cmd.Parameters.AddWithValue("p_TypeOfAgent_ID", TypeOfAgent_ID);
            cmd.Parameters.AddWithValue("p_RenewalAgent_ID", RenewalAgent_ID);
            cmd.Parameters.AddWithValue("p_RenewalAgent_Sequence", RenewalAgent_Sequence);
            cmd.Parameters.AddWithValue("p_RenewalAgent_Year", RenewalAgent_Year);
            cmd.Parameters.AddWithValue("p_RERARefNumber", RERARefNumber);
            cmd.Parameters.AddWithValue("p_Key_ID", Key_ID);
            cmd.Parameters.AddWithValue("p_Key_SubID", Key_SubID);
            cmd.Parameters.AddWithValue("p_UserNam", UserNam);
            MySqlDataAdapter sd = new MySqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            ...
            foreach (DataRow dr in dt.Rows)
            {
                AgentRenewalList.Add(
                       new Clsprp_AgentRenewal_ListPreviousRegistrations
                       {
                           AgentRenewal_ListPreviousRegistration_IndexID = Convert.ToInt64(dr["AgentRenewal_ListPreviousRegistration_IndexID"]),
                           AgentRenewal_ListPreviousRegistration_ID = Convert.ToInt64(dr["AgentRenewal_ListPreviousRegistration_ID"]),
                           ...
                           Agent_ID = Convert.ToInt64(dr["Agent_ID"]),
                           AgentType_ID = Convert.ToInt32(dr["AgentType_ID"]),
                           UserID = Convert.ToString(dr["UserID"]),
                           Related_RenewalAgent_ID = Convert.ToInt64(dr["Related_RenewalAgent_ID"]),
                           Related_RenewalAgent_Year = Convert.ToInt32(dr["Related_RenewalAgent_Year"]),
                           Renewal_OrderSequence = Convert.ToInt32(dr["Renewal_OrderSequence"]),
                           ...
                           RegDiaryNumber_Name = Convert.ToString(dr["RegDiaryNumber_Name"]),
                           RegDiaryNumber_Application_Date = Convert.ToDateTime(dr["RegDiaryNumber_Application_Date"]),
            ...
            return AgentRenewalList;
        }

        public bool Add_AgentRenewal_AddVerifyPreviousRegistration_HistoryLogs(Clsprp_AgentRenewal_VerifyPreviousRegistration smodel, Int32 TypeOfAgent, string userMode, string userRemarks, string userID, string userName)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_insert_tbl_RERA_AgentRenewal_Registration_Agree_HistoryLogs", con);
            cmd.CommandType = CommandType.StoredProcedure;

            #region Parameters
            cmd.Parameters.AddWithValue("p_AgentRenewal_VerifyPreviousRegistration_IndexID", smodel.AgentRenewal_VerifyPreviousRegistration_IndexID);
            cmd.Parameters.AddWithValue("p_AgentRenewal_VerifyPreviousRegistration_ID", smodel.AgentRenewal_VerifyPreviousRegistration_ID);
            cmd.Parameters.AddWithValue("p_RegistrationMode", String.IsNullOrEmpty(userMode) ? "" : userMode);
            ...
            cmd.Parameters.AddWithValue("p_RERAnumberIssueDate", smodel.RERAnumberIssueDate == null ? DateTime.MinValue : smodel.RERAnumberIssueDate);
            cmd.Parameters.AddWithValue("p_RERAnumberRegUptoDate", smodel.RERAnumberRegUptoDate == null ? DateTime.MinValue : smodel.RERAnumberRegUptoDate);

            cmd.Parameters.AddWithValue("p_Agent_ID", smodel.Agent_ID);
            cmd.Parameters.AddWithValue("p_TypeOfAgent_ID", TypeOfAgent);
            cmd.Parameters.AddWithValue("p_UserID", String.IsNullOrEmpty(userID) ? "" : userID);
            ...
            cmd.Parameters.AddWithValue("p_Renewal_OrderSequence", smodel.Renewal_OrderSequence);
            cmd.Parameters.AddWithValue("p_Renewal_OrderSequence_Name", String.IsNullOrEmpty(smodel.Renewal_OrderSequence_Name) ? "" : smodel.Renewal_OrderSequence_Name);

            cmd.Parameters.AddWithValue("p_Agent_RegDiaryNumber_Name", String.IsNullOrEmpty(smodel.Agent_RegDiaryNumber_Name) ? "" : smodel.Agent_RegDiaryNumber_Name);
            cmd.Parameters.AddWithValue("p_RenewalAgent_RegDiaryNumber_Name", String.IsNullOrEmpty(smodel.Related_RenewalAgentRegDiaryNumber_Name) ? "" : smodel.Related_RenewalAgentRegDiaryNumber_Name);
            cmd.Parameters.AddWithValue("p_Agent_Name", String.IsNullOrEmpty(smodel.Agent_Name) ? "" : smodel.Agent_Name);
            cmd.Parameters.AddWithValue("p_Agent_Type", String.IsNullOrEmpty(smodel.Agent_Type) ? "" : smodel.Agent_Type);

            cmd.Parameters.AddWithValue("p_Is_YesNo_AgentRenewalPermission_Flag", smodel.Is_YesNo_AgentRenewalPermission_Flag);
            cmd.Parameters.AddWithValue("p_Is_YesNo_ValidforAgentRenewal_Flag", smodel.Is_YesNo_ValidforAgentRenewal_Flag);
            cmd.Parameters.AddWithValue("p_RemarksIfAny", String.IsNullOrEmpty(userRemarks) ? "" : userRemarks);
