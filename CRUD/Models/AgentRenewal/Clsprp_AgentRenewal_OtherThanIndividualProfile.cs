...
{
    public class Clsprp_AgentRenewal_OtherThanIndividualProfile
    {
        ...
        [Required(ErrorMessage = "Any other Organization Members (Yes/No) field is required.")]
        ...
        public List<Clsprp_AgentRenewal_OtherThanIndividualProfile> AgentRenewal_OTIndProfile { get; set; }
        public Clsprp_AgentRenewal_OtherThanIndividualProfile()
        {
            AgentRenewal_OTIndProfile = new List<Clsprp_AgentRenewal_OtherThanIndividualProfile>();
        }        
    }
}