...
{
    public class Clsprp_AgentRenewal_Documents
    {
        ...
        public List<Clsprp_AgentRenewal_Documents> AgentRenewal_Document { get; set; }
        public Clsprp_AgentRenewal_Documents()
        {
            AgentRenewal_Document = new List<Clsprp_AgentRenewal_Documents>();
        }
    }
}