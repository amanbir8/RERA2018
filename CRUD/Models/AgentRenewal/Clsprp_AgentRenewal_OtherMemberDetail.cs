...
{
    public class Clsprp_AgentRenewal_OtherMemberDetail
    {
        ...
        public long Related_Agent_OtherMemberDetails_ID { get; set; }
        ...
        public string Image_FileSize { get; set; }
        public string Image_FileType { get; set; }
        ...
        public List<Clsprp_AgentRenewal_OtherMemberDetail> AgentRenewal_OtherMember { get; set; }
        public Clsprp_AgentRenewal_OtherMemberDetail()
        {
            AgentRenewal_OtherMember = new List<Clsprp_AgentRenewal_OtherMemberDetail>();
        }
    }
}