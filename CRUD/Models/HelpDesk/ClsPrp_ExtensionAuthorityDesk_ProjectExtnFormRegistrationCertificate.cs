...
{
    public class ClsPrp_ExtensionAuthorityDesk_ProjectExtnForm_RegistrationCertificate
    {
        public long ExtnRegdProjectCertificate_IndexID { get; set; }
        public long ExtnRegdProjectCertificate_ID { get; set; }
        public string RelatedProjectRegDiaryNumber_Name { get; set; }
        public string RelatedExtnProjectRegDiaryNumber_Name { get; set; }
        ...
        public List<ClsPrp_ExtensionAuthorityDesk_ProjectExtnForm_RegistrationCertificate> prpongoing { get; set; }
        public ClsPrp_ExtensionAuthorityDesk_ProjectExtnForm_RegistrationCertificate()
        {
            prpongoing = new List<ClsPrp_ExtensionAuthorityDesk_ProjectExtnForm_RegistrationCertificate>();
        }
