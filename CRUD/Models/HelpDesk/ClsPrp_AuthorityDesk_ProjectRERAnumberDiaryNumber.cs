...
{
    public class ClsPrp_AuthorityDesk_ProjectRERAnumberDiaryNumber
    {
        ...
        public List<ClsPrp_AuthorityDesk_ProjectRERAnumberDiaryNumber> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_ProjectRERAnumberDiaryNumber()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_ProjectRERAnumberDiaryNumber>();
        }
