...
{
    public class ClsPrp_AuthDesk_View_ExtensionFormPaymentIntegration
    {
        public long PaymentRefNumberExtensionForm_IndexID { get; set; }
        public long PaymentRefNumberExtensionForm_ID { get; set; }

        public long RelatedExtensionForm_ProjectID { get; set; }
        public string RelatedExtensionForm_ProjectCode { get; set; }
        public long RelatedExtensionForm_PromoterID { get; set; }//new
        public string RelatedExtensionForm_PromoterCode { get; set; }//new

        public long RelatedPayment_ID { get; set; }
        public long RelatedPayment_IndexID { get; set; }//new
        public string User_ID { get; set; }

        public string ExtensionForm_Type { get; set; }
        public string User_Name { get; set; }
        public string ProjectPmZoneType { get; set; }//new
        public string PromoterType_IO { get; set; }//new

        [Display(Name = "Transaction/ Payment Status")]
        public string ExtensionForm_BriefSummary { get; set; }
        ...
        public List<ClsPrp_AuthDesk_View_ExtensionFormPaymentIntegration> ExtensionFormPaymentTranasactions { get; set; }
        public ClsPrp_AuthDesk_View_ExtensionFormPaymentIntegration()
        {
            ExtensionFormPaymentTranasactions = new List<ClsPrp_AuthDesk_View_ExtensionFormPaymentIntegration>();
        }
