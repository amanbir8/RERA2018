...
{
    public class ClsPrp_AuthorityDesk_ProjectRERAnumberDetails
    {
        ...
        public List<ClsPrp_AuthorityDesk_ProjectRERAnumberDetails> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_ProjectRERAnumberDetails()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_ProjectRERAnumberDetails>();
        }
    }
}