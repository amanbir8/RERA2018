...
{
    public class ClsPrp_AuthDesk_View_ProjectBuildingTowerBlock_Construction
    {
        ...
        public int IsDraftListConstruction { get; set; }
        public int IsDraftListInventory { get; set; }
        public int IsDraftListParking { get; set; }
        public int IsDraftListExternalfac { get; set; }
        public int IsDraftListInternalfac { get; set; }

        public List<ClsPrp_AuthDesk_View_ProjectBuildingTowerBlock_Construction> prpongoing { get; set; }

        public ClsPrp_AuthDesk_View_ProjectBuildingTowerBlock_Construction()
        {
            prpongoing = new List<ClsPrp_AuthDesk_View_ProjectBuildingTowerBlock_Construction>();

        }

        public List<ClsPrp_AuthDesk_View_ProjectBuildingTowerBlock_Inventory> PrpInventory { get; set; }
        public List<ClsPrp_AuthDesk_View_ProjectInternalInfrastructure_Facilities> PrpInternalFacility { get; set; }
        public List<ClsPrp_AuthDesk_View_ProjectExternalInfrastructure_Facilities> PrpExternalFacility { get; set; }
        public List<ClsPrp_AuthDesk_View_ParkingDetails> PrpParking { get; set; }
