...
{
    public class ClsPrp_AuthDesk_View_ExtensionProjectExtensionFormDetails
    {
        ...
        public int IsDraftAllextensionformwithdocuments { get; set; }
        ...
        public List<ClsPrp_AuthDesk_View_ExtensionProjectExtensionFormDetails> prpongoing { get; set; }
        public ClsPrp_AuthDesk_View_ExtensionProjectExtensionFormDetails()
        {
            prpongoing = new List<ClsPrp_AuthDesk_View_ExtensionProjectExtensionFormDetails>();
