...
{
    public class ClsPrp_AuthorityDesk_QUpdatesProject_ExternalFacilities
    {
        ...
        public List<ClsPrp_AuthorityDesk_QUpdatesProject_ExternalFacilities> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_QUpdatesProject_ExternalFacilities()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_QUpdatesProject_ExternalFacilities>();
