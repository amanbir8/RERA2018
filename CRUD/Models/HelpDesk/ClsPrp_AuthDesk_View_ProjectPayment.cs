...
{
    public class ClsPrp_AuthDesk_View_ProjectPayment
    {
        ...
        public List<ClsPrp_AuthDesk_View_ProjectPayment> prpongoing { get; set; }
        public ClsPrp_AuthDesk_View_ProjectPayment()
        {
            prpongoing = new List<ClsPrp_AuthDesk_View_ProjectPayment>();
