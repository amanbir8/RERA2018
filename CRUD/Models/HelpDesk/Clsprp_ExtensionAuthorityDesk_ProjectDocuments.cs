...
{
    public class Clsprp_ExtensionAuthorityDesk_ProjectDocuments
    {
        ...
        public List<Clsprp_ExtensionAuthorityDesk_ProjectDocuments> prpongoing { get; set; }
        public Clsprp_ExtensionAuthorityDesk_ProjectDocuments()
        {
            prpongoing = new List<Clsprp_ExtensionAuthorityDesk_ProjectDocuments>();
        }

        public List<Clsprp_AuthDesk_View_ProjectDocuments> prpPrmProjectDocList { get; set; }
    }
}