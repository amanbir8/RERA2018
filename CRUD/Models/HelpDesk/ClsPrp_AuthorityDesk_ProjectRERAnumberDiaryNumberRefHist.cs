...
{
    public class ClsPrp_AuthorityDesk_ProjectRERAnumberDiaryNumberRefHist
    {
        ...
        public string RERAregistrationcode { get; set; }

        public List<ClsPrp_AuthorityDesk_ProjectRERAnumberDiaryNumberRefHist> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_ProjectRERAnumberDiaryNumberRefHist()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_ProjectRERAnumberDiaryNumberRefHist>();
        }
