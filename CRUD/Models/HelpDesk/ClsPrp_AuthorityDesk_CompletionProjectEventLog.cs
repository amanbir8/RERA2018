...
{
    public class ClsPrp_AuthorityDesk_CompletionProjectEventLog
    {
        ...
        public List<ClsPrp_AuthorityDesk_CompletionProjectEventLog> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_CompletionProjectEventLog()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_CompletionProjectEventLog>();
        }
