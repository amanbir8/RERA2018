...
{
    public class ClsMethod_View_ExtensionProjectExtensionFormPayment
    {
        ...
        public List<ClsPrp_AuthDesk_View_ExtensionProjectExtensionFormPayment> Display_Project_ExtensionFormPayments(Int64 ProjectRegistration_ID)
        {
            connection();
            List<ClsPrp_AuthDesk_View_ExtensionProjectExtensionFormPayment> Projectlist = new List<ClsPrp_AuthDesk_View_ExtensionProjectExtensionFormPayment>();

            MySqlCommand cmd = new MySqlCommand("Display_RERA_Project_ExtensionFormPaymentsForDesk", con);
            ...
            {
                Projectlist.Add(
                       new ClsPrp_AuthDesk_View_ExtensionProjectExtensionFormPayment
                       {
        ...
        public List<ClsPrp_AuthDesk_View_ExtensionFormPaymentIntegration> Display_Project_ExtensionFormPaymentTransactions(Int64 ProjectRegistration_ID)
        {
            connection();
            List<ClsPrp_AuthDesk_View_ExtensionFormPaymentIntegration> Application_List = new List<ClsPrp_AuthDesk_View_ExtensionFormPaymentIntegration>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_Project_ExtensionForm_PaymentGatewayDetails_ForDesk", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("p_ExtensionForm_ProjectRegistration_ID", ProjectRegistration_ID);
            MySqlDataAdapter sd = new MySqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            ...
            foreach (DataRow dr in dt.Rows)
            {
                Application_List.Add(
                       new ClsPrp_AuthDesk_View_ExtensionFormPaymentIntegration
                       {
