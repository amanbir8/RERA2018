...
{
    public class ClsPrp_AuthorityDesk_ProjectRERAnumberSummaryDetails
    {
        public string Prepared_SequenceNumber { get; set; }
        public string Prepared_ProjectType { get; set; }
        ...
        public List<ClsPrp_AuthorityDesk_ProjectRERAnumberSummaryDetails> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_ProjectRERAnumberSummaryDetails()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_ProjectRERAnumberSummaryDetails>();
        }
    }
}