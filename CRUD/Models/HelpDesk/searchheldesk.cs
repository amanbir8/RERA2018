...
namespace CRUD.Models.HelpDesk
{
    public class searchhelpdesk
    {
       ...
       // public string PromoterAuthSignFormB { get; set; }
        ...
        public string rcdProjectRERAcertInfoName { get; set; }
        public string rcdProjectRERAcertFilePath { get; set; }
        public string rcdProjectRERAcertFileName { get; set; }
        [DisplayFormat(DataFormatString = "{0:dd-MMM-yyyy}", ApplyFormatInEditMode = true)]
        public DateTime? rcdProjectRERAcertIssueDate { get; set; }

        [Display(Name = "Remarks, If Any")]
        [DataType(DataType.MultilineText)]
        public string rcdRemarksIfAny { get; set; }


        public string rceProjectRERAcertInfoName { get; set; }
        public string rceProjectRERAcertReferenceNumber { get; set; }
        public string rceProjectRERAcertFilePath { get; set; }
        public string rceProjectRERAcertFileName { get; set; }
        public string rceRERAnumberRegistration { get; set; }
        [DisplayFormat(DataFormatString = "{0:dd-MMM-yyyy}", ApplyFormatInEditMode = true)]
        public DateTime? rceExtnRegistrationIssueDate { get; set; }
        [DisplayFormat(DataFormatString = "{0:dd-MMM-yyyy}", ApplyFormatInEditMode = true)]
        public DateTime? rceExtnRegistrationRegUptoDate { get; set; }


        public string rccPCCInfoDetails { get; set; }
        public string rccPCCReferenceName { get; set; }
        public DateTime? rccPCCReferenceDate { get; set; }
        public string rccPCCCertificateStatus { get; set; }
        public string rccPCCReciptType { get; set; }
        public string rccRemarksIfAny { get; set; }
        public string rccExtra2 { get; set; }
        public string rccExtra3 { get; set; }


        public int reRelatedExtnRegDiaryNumberID { get; set; }
        public string reRelatedExtnRegDiaryNumberName { get; set; }
        public DateTime? reRelatedExtnRegDiaryNumberCreatedDate { get; set; }
        public string reExtnRegistrationNumber { get; set; }
        public DateTime? reExtnRegistrationIssueDate { get; set; }
        public DateTime? ExtnRegistrationRegUptoDate { get; set; }


        public int RevokeProjectIndexID { get; set; }
        public int rvdRevokeProjectID { get; set; }
        public string rvdRevokesRegDiaryNumberName { get; set; }
        public DateTime? rvdRERAnumberExtensionRegUptoDate { get; set; }
        public string rvdProjectType { get; set; }
        public string rvdRevokeInfoDetails { get; set; }
        public string rvdRevokeIssueAuthority { get; set; }
        public string rvdRevokeReferenceName { get; set; }
        public DateTime? rvdRevokeReferenceDate { get; set; }
        public string rvdRevokeType { get; set; }

        public string Reg_PromoterRegDiaryNumber_Name { get; set; } //always come
        ...
        public List<searchhelpdesk> prpongoing { get; set; }
        public searchhelpdesk()
        {
            prpongoing = new List<searchhelpdesk>();
        }
    }
}