...
{
    public class ClsPrp_AuthDesk_View_ProjectInternalInfrastructure_Facilities
    {
        ...
        public List<ClsPrp_AuthDesk_View_ProjectInternalInfrastructure_Facilities> prpongoing { get; set; }
        public ClsPrp_AuthDesk_View_ProjectInternalInfrastructure_Facilities()
        {
            prpongoing = new List<ClsPrp_AuthDesk_View_ProjectInternalInfrastructure_Facilities>();
