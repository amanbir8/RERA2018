...
{
    public class ClsPrp_ExtensionAuthorityDesk_ProjectEventLog
    {

        public long ProjectExtFormEventAction_ID { get; set; }
        [Required]
        ...
        public List<ClsPrp_ExtensionAuthorityDesk_ProjectEventLog> prpongoing { get; set; }
        public ClsPrp_ExtensionAuthorityDesk_ProjectEventLog()
        {
            prpongoing = new List<ClsPrp_ExtensionAuthorityDesk_ProjectEventLog>();
