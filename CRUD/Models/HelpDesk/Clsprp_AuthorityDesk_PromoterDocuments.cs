...
{
    public class Clsprp_AuthorityDesk_PromoterDocuments
    {
        ...
        public int IsDraftListDocuments { get; set; }

        //public List<Clsprp_Master_Promoter_Documents> MasterDocs { get; set; }

        public List<Clsprp_AuthorityDesk_PromoterDocuments> prpongoing { get; set; }
        public List<Clsprp_AuthorityDesk_PromoterDocuments> prpPromoterDocList { get; set; }
    }
}