...
{
    public class Clsprp_AuthDesk_View_ProjectDocuments
    {
        ...
        public List<Clsprp_AuthDesk_View_ProjectDocuments> prpongoing { get; set; }

        public Clsprp_AuthDesk_View_ProjectDocuments()
        {
            prpongoing = new List<Clsprp_AuthDesk_View_ProjectDocuments>();
        }
