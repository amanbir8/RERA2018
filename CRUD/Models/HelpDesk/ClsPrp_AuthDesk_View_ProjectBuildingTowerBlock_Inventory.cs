...
{
    public class ClsPrp_AuthDesk_View_ProjectBuildingTowerBlock_Inventory
    {
        ...
        public List<ClsPrp_AuthDesk_View_ProjectBuildingTowerBlock_Inventory> prpongoing { get; set; }
        public ClsPrp_AuthDesk_View_ProjectBuildingTowerBlock_Inventory()
        {
            prpongoing = new List<ClsPrp_AuthDesk_View_ProjectBuildingTowerBlock_Inventory>();
