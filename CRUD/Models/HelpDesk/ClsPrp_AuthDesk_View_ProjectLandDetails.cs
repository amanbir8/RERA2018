...
{
    public class ClsPrp_AuthDesk_View_ProjectLandDetails
    {
        ...
        [Required]
        [Display(Name = "Total Area of Land Proposed to be developed")]
        ...
        [Display(Name = "Area under group housing development")]
        public double ProposedLand_Area_ResidentialGroupHousing { get; set; }

        [Required]
        [RegularExpression(@"^\d+.?\d{0,4}$", ErrorMessage = "Invalid Area; Maximum Four Decimal Points.")]
        [Range(0, 999999999999.9999)]
        [Display(Name = "Area under residential plotted development")]
        public double ProposedLand_Area_ResidentialPlotted { get; set; }

        [Required]
        [RegularExpression(@"^\d+.?\d{0,4}$", ErrorMessage = "Invalid Area; Maximum Four Decimal Points.")]
        [Range(0, 999999999999.9999)]
        [Display(Name = "Area under commercial development")]
        public double ProposedLand_Area_Commercial { get; set; }

        [Required]
        [RegularExpression(@"^\d+.?\d{0,4}$", ErrorMessage = "Invalid Area; Maximum Four Decimal Points.")]
        [Range(0, 999999999999.9999)]
        [Display(Name = "Area under industrial development")]
        ...
        [RegularExpression(@"^\d+.?\d{0,4}$", ErrorMessage = "Invalid Area; Maximum Four Decimal Points.")]
        [Range(0, 999999999999.9999)]
        [Display(Name = "Area under institution, club, school and reserved area development")]
        ...
        [Required]
        [Display(Name = "Project Land Encumbrances")]
        ...
        public int IsDraftKhasraDetails { get; set; }

        public List<ClsPrp_AuthDesk_View_ProjectLandDetails> prpongoing { get; set; }

        public ClsPrp_AuthDesk_View_ProjectLandDetails()
        {
            prpongoing = new List<ClsPrp_AuthDesk_View_ProjectLandDetails>();

        }
        //public List<ClsPrp_Project_Master> ProjectMaster { get; set; }

        #region// Project Land Details        
        public List<ClsPrp_AuthDesk_View_ProjectKhasraAreaDetails> List_Project_KhasraAreaDetails { get; set; }
        #endregion
