...
{
    public class ClsPrp_AuthDesk_View_ProjectPaymentIntegration
    {
        public long PaymentRefNumberProjectPm_IndexID { get; set; }
        [Display(Name = "Payment Reference Number (PRN)")]
        ...
        public List<ClsPrp_AuthDesk_View_ProjectPaymentIntegration> ProjectPaymentTranasactions { get; set; }
        public ClsPrp_AuthDesk_View_ProjectPaymentIntegration()
        {
            ProjectPaymentTranasactions = new List<ClsPrp_AuthDesk_View_ProjectPaymentIntegration>();
        }
