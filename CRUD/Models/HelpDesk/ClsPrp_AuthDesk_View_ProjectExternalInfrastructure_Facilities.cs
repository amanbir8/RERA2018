...
{
    public class ClsPrp_AuthDesk_View_ProjectExternalInfrastructure_Facilities
    {
        ...
        public List<ClsPrp_AuthDesk_View_ProjectExternalInfrastructure_Facilities> prpongoing { get; set; }
        public ClsPrp_AuthDesk_View_ProjectExternalInfrastructure_Facilities()
        {
            prpongoing = new List<ClsPrp_AuthDesk_View_ProjectExternalInfrastructure_Facilities>();
