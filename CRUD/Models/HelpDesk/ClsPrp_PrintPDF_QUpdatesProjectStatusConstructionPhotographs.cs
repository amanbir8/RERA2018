...
{
    public class ClsPrp_PrintPDF_QUpdatesProjectStatusConstructionPhotographs
    {
        ...
        public List<ClsPrp_PrintPDF_QUpdatesProjectStatusConstructionPhotographs> prpongoing { get; set; }
        public ClsPrp_PrintPDF_QUpdatesProjectStatusConstructionPhotographs()
        {
            prpongoing = new List<ClsPrp_PrintPDF_QUpdatesProjectStatusConstructionPhotographs>();
        }
        public List<ClsPrp_PrintPDF_QUpdatesProjectDiaryNumberDetails> prpQUProjectDiaryNumberDetails { get; set; }
    }
}