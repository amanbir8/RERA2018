...
{
    public class ClsMethod_View_QuarterlyUpdatesProjectStatusExternalFacilities
    {
        ...
        public List<ClsPrp_AuthorityDesk_QUpdatesProject_ExternalFacilities> Display_QuarterlyUpdatesProject_StatusOfExternalFacilities(Int64 ProjectID, Int64 PromoterID, Int32 QuarterYear, string QuarterName, Int32 viewCriteriaFlag, string UserRole)
        {
            connection();
            List<ClsPrp_AuthorityDesk_QUpdatesProject_ExternalFacilities> ProjectList = new List<ClsPrp_AuthorityDesk_QUpdatesProject_ExternalFacilities>();

            MySqlCommand cmd = new MySqlCommand("Display_RERA_QUpdatesProject_StatusExternalFacilitiesForDesk", con);
            ...
            {
                ProjectList.Add(
                       new ClsPrp_AuthorityDesk_QUpdatesProject_ExternalFacilities
                       {
        ...
        public Int32 Update_PublicUnpublicHandler_QuarterlyUpdatesProject_StatusOfExternalFacilitiesByIndex(Int64 ProjectID, Int64 RelatedRefIndexID, Int64 RelatedRefID, string PublicUnpublicCode, string UserName, string UserID, string RelatedRemarksIfAny, string RelatedPVMsg)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_setpublicview_tbl_rera_QUpdatesProject_ExternalFacsByIndex", con);
            cmd.CommandType = CommandType.StoredProcedure;
