...
{
    public class ClsPrp_ExtensionAuthorityDesk_ProjectSubCheckListLog
    {
        ...
        public List<ClsPrp_ExtensionAuthorityDesk_ProjectSubCheckListLog> prpongoing { get; set; }
        public ClsPrp_ExtensionAuthorityDesk_ProjectSubCheckListLog()
        {
            prpongoing = new List<ClsPrp_ExtensionAuthorityDesk_ProjectSubCheckListLog>();
        }

        public List<ClsPrp_ExtensionAuthorityDesk_ProjectSubCheckList_Master> SubCheckListMaster { get; set; }
    }
}