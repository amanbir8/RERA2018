...
{
    public class ClsPrp_AuthorityDesk_RevocationCancellationProjectEventLog
    {
        public long ProjectRevokeEventAction_ID { get; set; }
        [Required]
        ...
        public string ProjectRegistrationNumberName { get; set; }

        public List<ClsPrp_AuthorityDesk_RevocationCancellationProjectEventLog> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_RevocationCancellationProjectEventLog()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_RevocationCancellationProjectEventLog>();
        }
