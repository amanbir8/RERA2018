...
{
    public class ClsPrp_ComplaintProfile
    {
        ...
        public List<ClsPrp_ComplaintProfile> ComplaintProfile { get; set; }
        ...
        public ClsPrp_ComplaintProfile()
        {
            ComplaintProfile = new List<ClsPrp_ComplaintProfile>();
