...
{
    public class ClsMethod_ComplaintFormN_PreHearingNotice
    {
        ...
        public List<ClsPrp_ComplaintFormN_PreHearingNotice> Display_ComplaintFormN_PreHearingNoticeByID(Int64 ComplaintFormN_ID, Int64 PreHearingNotice_ID,string DiaryNumber, string UserName, string UserID, string SourceHostName, string SourceIP)
        {
            connection();
            List<ClsPrp_ComplaintFormN_PreHearingNotice> ProjectFivelist1 = new List<ClsPrp_ComplaintFormN_PreHearingNotice>();
            // Display_Rera_AuthDesk_Complaint_FormN_PreHearingNoticeByID
            MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_FormN_PreHearingNoticeWithLog_ByID", con);
            ...
            cmd.Parameters.AddWithValue("p_ComplaintDiaryNumber", DiaryNumber);
            cmd.Parameters.AddWithValue("p_UserName", UserName);
            cmd.Parameters.AddWithValue("p_UserID", UserID);
            cmd.Parameters.AddWithValue("p_SourceHostName", SourceHostName);
            cmd.Parameters.AddWithValue("p_SourceIP", SourceIP);
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ProjectFivelist1.Add(
                       new ClsPrp_ComplaintFormN_PreHearingNotice
                       {
