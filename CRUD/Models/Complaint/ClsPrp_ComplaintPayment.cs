...
{
    public class ClsPrp_ComplaintPayment
    {
        public long ComplaintPayment_IndexID { get; set; }
        public long ComplaintPayment_ID { get; set; }
       
        [Display(Name = "Complaint Title and Reference Number")]
        public long ComplaintPaymentRelated_ComplaintRegistration_ID { get; set; }

        [Required]
        [Display(Name = "Payment Type")]
        public int ComplaintPayment_TitleCode { get; set; }

        [Required]
        [Display(Name = "Payment Type Title")]
        public string ComplaintPayment_TitleName { get; set; }
        ...
        public string I_column { get; set; }
        public string J_column { get; set; }
        ...
        public List<ClsPrp_ComplaintPayment> prpongoing { get; set; }
        public ClsPrp_ComplaintPayment()
        {
            prpongoing = new List<ClsPrp_ComplaintPayment>();

        }
        public List<ClsPrp_Complaint_ReferenceNumberMaster> ComplaintReferenceMaster { get; set; }
