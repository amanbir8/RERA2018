...
{
    public class ClsPrp_ComplaintFormM_DiaryNumberDashbaord
    {
        ...
        public List<ClsPrp_ComplaintFormM_DiaryNumberDashbaord> prpongoing { get; set; }
        public ClsPrp_ComplaintFormM_DiaryNumberDashbaord()
        {
            prpongoing = new List<ClsPrp_ComplaintFormM_DiaryNumberDashbaord>();
