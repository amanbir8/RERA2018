...
{
    public class ClsPrp_ComplaintFormN_PreHearingNotice
    {
        ...
        public List<ClsPrp_ComplaintFormN_PreHearingNotice> prpongoingNotice { get; set; }
        public ClsPrp_ComplaintFormN_PreHearingNotice()
        {
            prpongoingNotice = new List<ClsPrp_ComplaintFormN_PreHearingNotice>();
