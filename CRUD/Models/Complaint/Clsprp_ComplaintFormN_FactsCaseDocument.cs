...
{
    public class Clsprp_ComplaintFormN_FactsCaseDocument
    {
        ...
        public List<Clsprp_ComplaintFormN_FactsCaseDocument> prpFormN_FactsCase_Docs { get; set; }
        public Clsprp_ComplaintFormN_FactsCaseDocument()
        {
            prpFormN_FactsCase_Docs = new List<Clsprp_ComplaintFormN_FactsCaseDocument>();
        }
    }
}