...
{
    public class ClsPrp_ComplaintFormN_DiaryNumberDashbaord
    {
        ...
        public List<ClsPrp_ComplaintFormN_DiaryNumberDashbaord> prpongoing { get; set; }
        public ClsPrp_ComplaintFormN_DiaryNumberDashbaord()
        {
            prpongoing = new List<ClsPrp_ComplaintFormN_DiaryNumberDashbaord>();
