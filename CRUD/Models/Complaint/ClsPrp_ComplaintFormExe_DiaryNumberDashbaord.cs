...
{
    public class ClsPrp_ComplaintFormExe_DiaryNumberDashbaord
    {
        ...
        public List<ClsPrp_ComplaintFormExe_DiaryNumberDashbaord> prpongoing { get; set; }
        public ClsPrp_ComplaintFormExe_DiaryNumberDashbaord()
        {
            prpongoing = new List<ClsPrp_ComplaintFormExe_DiaryNumberDashbaord>();
