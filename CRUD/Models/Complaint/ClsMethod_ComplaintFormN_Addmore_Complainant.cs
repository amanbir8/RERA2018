...
{
    public class ClsMethod_ComplaintFormN_Addmore_Complainant
    {
        ...
        public Int64 Add_FormN_Complainant(ClsPrp_ComplaintFormMN_Addmore_Complainant smodel, string UID, string userName)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_insert_tbl_rera_complaint_formn_AddtionComplainant", con);
        ...
        public List<ClsPrp_ComplaintFormMN_Addmore_Complainant> Display_ComplainantFormN_Detail(Int64 parmProfile_ID, Int64 parmComplaint_ID, string parmFormType_ID, string parmUser_ID, Int32 parmSessionTempFlag)
        {
            connection();
            ...
            MySqlCommand cmd = new MySqlCommand("Display_rera_Complaint_FormN_AddtionalComplainant", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool Delete_FormN_Complainant(Int64 AddComplaint_ID, Int64 AddComplaint_IndexID, Int64 AddProfile_ID)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("Delete_Rera_Complaint_FormN_AdditionalComplainantByID", con);
            cmd.CommandType = CommandType.StoredProcedure;

            cmd.Parameters.AddWithValue("p_AdditionComplainantN_ID", AddComplaint_ID);
            cmd.Parameters.AddWithValue("p_AdditionComplainantN_IndexID", AddComplaint_IndexID);
