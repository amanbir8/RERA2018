...
{
    public class ClsPrp_ComplaintFormMN_Addmore_Complainant
    {
        ...
        public List<ClsPrp_ComplaintFormMN_Addmore_Complainant> FormMN_Complainant { get; set; }
        public ClsPrp_ComplaintFormMN_Addmore_Complainant()
        {
            FormMN_Complainant = new List<ClsPrp_ComplaintFormMN_Addmore_Complainant>();
        }
