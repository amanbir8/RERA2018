...
{
    public class ClsMethod_ComplaintFormN_Addmore_Respondent
    {
        ...
        public Int64 Add_FormN_Respondent(ClsPrp_ComplaintFormMN_Addmore_Respondent smodel, string UID, string userName)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_insert_tbl_rera_complaint_formn_AddtionRespondent", con);
        ...
        public List<ClsPrp_ComplaintFormMN_Addmore_Respondent> Display_RespondentFormN_Detail(Int64 parmProfile_ID, Int64 parmComplaint_ID, string parmFormType_ID, string parmUser_ID, Int32 parmSessionTempFlag)
        {
            connection();
            ...
            MySqlCommand cmd = new MySqlCommand("Display_rera_Complaint_FormN_AddtionalRespondent", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool Delete_FormN_Respondent(Int64 AddRespondent_ID, Int64 AddRespondent_IndexID, Int64 AddProfile_ID)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("Delete_Rera_Complaint_FormN_AdditionalRespondentByID", con);
            cmd.CommandType = CommandType.StoredProcedure;

            cmd.Parameters.AddWithValue("p_AdditionRespondentN_ID", AddRespondent_ID);
            cmd.Parameters.AddWithValue("p_AdditionRespondentN_IndexID", AddRespondent_IndexID);
