...
{
    public class ClsMethod_ComplaintM_DiaryNumberDashbaord
    {
        ...
        public List<ClsPrp_ComplaintFormM_DiaryNumberDashbaord> Display_ComplaintFormM_RegDiaryNumberByProfileID(Int64 Profile_ID, string UserID_Role)
        {
            connection();
            List<ClsPrp_ComplaintFormM_DiaryNumberDashbaord> ProjectFivelist1 = new List<ClsPrp_ComplaintFormM_DiaryNumberDashbaord>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_FormM_RegDiaryNumberByProfileID", con);
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ProjectFivelist1.Add(
                       new ClsPrp_ComplaintFormM_DiaryNumberDashbaord
                       {
        ...
        public List<ClsPrp_ComplaintFormExe_DiaryNumberDashbaord> Display_ComplaintFormExe_RegDiaryNumberByProfileID(Int64 Profile_ID, string UserID_Role)
        {
            connection();
            List<ClsPrp_ComplaintFormExe_DiaryNumberDashbaord> ProjectFivelist1 = new List<ClsPrp_ComplaintFormExe_DiaryNumberDashbaord>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_Execution_Form_RegDiaryNumberByProfileID", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("p_Profile_ID", Profile_ID);
            cmd.Parameters.AddWithValue("p_UserRole", UserID_Role);
            ...
            {
                ProjectFivelist1.Add(
                       new ClsPrp_ComplaintFormExe_DiaryNumberDashbaord
                       {
