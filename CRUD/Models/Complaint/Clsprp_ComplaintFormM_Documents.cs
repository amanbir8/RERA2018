...
{
    public class Clsprp_ComplaintFormM_Documents
    {
        ...
        public List<Clsprp_ComplaintFormM_Documents> prpFormM_Docs { get; set; }
        public Clsprp_ComplaintFormM_Documents()
        {
            prpFormM_Docs = new List<Clsprp_ComplaintFormM_Documents>();
        }
    }
}