...
{
    public class ClsMethod_ComplaintFormM_PreHearingNotice
    {
        ...
        public List<ClsPrp_ComplaintFormM_PreHearingNotice> Display_ComplaintFormM_PreHearingNoticeByID(Int64 ComplaintFormM_ID, Int64 PreHearingNotice_ID, string DiaryNumber, string UserName, string UserID, string SourceHostName, string SourceIP)
        {
            connection();
            List<ClsPrp_ComplaintFormM_PreHearingNotice> ProjectFivelist1 = new List<ClsPrp_ComplaintFormM_PreHearingNotice>();
            // Display_Rera_AuthDesk_Complaint_FormM_PreHearingNoticeByID
            MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_FormM_PreHearingNoticeWithLog_ByID", con);
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ProjectFivelist1.Add(
                       new ClsPrp_ComplaintFormM_PreHearingNotice
                       {
