...
{
    public class ClsMethod_ComplaintN_DiaryNumberDashbaord
    {
        ...
        public List<ClsPrp_ComplaintFormN_DiaryNumberDashbaord> Display_ComplaintFormN_RegDiaryNumberByProfileID(Int64 Profile_ID, string UserID_Role)
        {
            connection();
            List<ClsPrp_ComplaintFormN_DiaryNumberDashbaord> ProjectFivelist1 = new List<ClsPrp_ComplaintFormN_DiaryNumberDashbaord>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_FormN_RegDiaryNumberByProfileID", con);
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ProjectFivelist1.Add(
                       new ClsPrp_ComplaintFormN_DiaryNumberDashbaord
                       {
