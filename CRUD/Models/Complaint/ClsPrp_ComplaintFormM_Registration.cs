...
{
    public class ClsPrp_ComplaintFormM_Registration
    {
        ...
        public List<ClsPrp_ComplaintFormM_Registration> ComplaintFormMstepI { get; set; }
        public ClsPrp_ComplaintFormM_Registration()
        {
            ComplaintFormMstepI = new List<ClsPrp_ComplaintFormM_Registration>();
        }
        ...
        public List<Clsprp_ComplaintFormM_FactsCaseDocument> FactsCase_Documents { get; set; }
