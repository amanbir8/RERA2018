...
{
    public class ClsprpMIS_ComplaintFormM
    {
        ...
        public List<ClsprpMIS_ComplaintFormM> prpongoing { get; set; }
        public ClsprpMIS_ComplaintFormM()
        {
            prpongoing = new List<ClsprpMIS_ComplaintFormM>();
        }
    }
}
