...
{
    public class ClsprpMIS_ProjectPaymentsRegistration
    {
        // Project General
        ...
        public List<ClsprpMIS_ProjectPaymentsRegistration> prpongoing { get; set; }
        public ClsprpMIS_ProjectPaymentsRegistration()
        {
            prpongoing = new List<ClsprpMIS_ProjectPaymentsRegistration>();
        }
    }
}