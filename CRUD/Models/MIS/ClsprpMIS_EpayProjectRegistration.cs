...
{
    public class ClsprpMIS_EpayProjectRegistration
    {
        ...
        public List<ClsprpMIS_EpayProjectRegistration> prpongoing { get; set; }
        public ClsprpMIS_EpayProjectRegistration()
        {
            prpongoing = new List<ClsprpMIS_EpayProjectRegistration>();
        }
    }
}