...
{
    public class ClsprpMIS_AgentEpayPayment
    {
        ...
        public List<ClsprpMIS_AgentEpayPayment> prpongoing { get; set; }
        public ClsprpMIS_AgentEpayPayment()
        {
            prpongoing = new List<ClsprpMIS_AgentEpayPayment>();
        }
    }
}