...
{
    public class ClsprpMIS_ComplaintFormN
    {
        ...
        public List<ClsprpMIS_ComplaintFormN> prpongoing { get; set; }
        public ClsprpMIS_ComplaintFormN()
        {
            prpongoing = new List<ClsprpMIS_ComplaintFormN>();
        }
    }
}
