...
{
    public class ClsprpMIS_ProjectPaymentsMiscAdditionalExportToExcel
    {
        // Project General
        ...
        public List<ClsprpMIS_ProjectPaymentsMiscAdditionalExportToExcel> prpongoing { get; set; }
        public ClsprpMIS_ProjectPaymentsMiscAdditionalExportToExcel()
        {
            prpongoing = new List<ClsprpMIS_ProjectPaymentsMiscAdditionalExportToExcel>();
        }
    }
}