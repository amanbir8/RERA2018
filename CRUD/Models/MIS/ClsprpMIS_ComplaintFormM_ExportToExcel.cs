...
{
    public class ClsprpMIS_ComplaintFormM_ExportToExcel
    {
        [Display(Name = "Complaint Diary Number")]
        public string Complaint_Diary_Number { get; set; }
        ...
        public List<ClsprpMIS_ComplaintFormM_ExportToExcel> prpongoing { get; set; }
        public ClsprpMIS_ComplaintFormM_ExportToExcel()
        {
            prpongoing = new List<ClsprpMIS_ComplaintFormM_ExportToExcel>();
        }
    }
}
