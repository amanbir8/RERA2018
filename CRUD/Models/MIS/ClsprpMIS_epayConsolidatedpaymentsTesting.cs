...
{
    public class ClsprpMIS_epayConsolidatedpaymentsTesting
    {
            // Project General
        ...
        public string Application_GroupOptionFlag { get; set; }
        ...
        [Display(Name = "Search Option")]
            ...
            public List<ClsprpMIS_epayConsolidatedpaymentsTesting> prpongoing { get; set; }
            public ClsprpMIS_epayConsolidatedpaymentsTesting()
            {
                prpongoing = new List<ClsprpMIS_epayConsolidatedpaymentsTesting>();
            }
        }
}