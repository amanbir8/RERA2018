...
{
    public class ClsPrp_Project_ExternalInfrastructure_Facilities
    {
        ...
        public List<ClsPrp_Project_ExternalInfrastructure_Facilities> prpongoing { get; set; }
        public ClsPrp_Project_ExternalInfrastructure_Facilities()
        {
            prpongoing = new List<ClsPrp_Project_ExternalInfrastructure_Facilities>();
