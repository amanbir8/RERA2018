...
{
    public class ClsPrp_QUpdateProject_ParkingDetails
    {
        ...
        public List<ClsPrp_QUpdateProject_ParkingDetails> prpongoing { get; set; }
        public ClsPrp_QUpdateProject_ParkingDetails()
        {
            prpongoing = new List<ClsPrp_QUpdateProject_ParkingDetails>();
        }
