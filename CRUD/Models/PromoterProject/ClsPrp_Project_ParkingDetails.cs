...
{
    public class ClsPrp_Project_ParkingDetails
    {
        ...
        public List<ClsPrp_Project_ParkingDetails> prpongoing { get; set; }
        public ClsPrp_Project_ParkingDetails()
        {
            prpongoing = new List<ClsPrp_Project_ParkingDetails>();
