...
{
    public class Clsprp_Project_Documents
    {
        ...
        public List<Clsprp_Project_Documents> prpongoing { get; set; }

        public Clsprp_Project_Documents()
        {
            prpongoing = new List<Clsprp_Project_Documents>();
        }
    }
}