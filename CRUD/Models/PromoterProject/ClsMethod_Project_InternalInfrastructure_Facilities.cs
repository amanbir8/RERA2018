...
{
    public class ClsMethod_Project_InternalInfrastructure_Facilities
    {
        ...
        public bool Add_Project_InternalInfrastructure_Facilities(ClsPrp_Project_InternalInfrastructure_Facilities smodel, Int64 Project_id)// string PANaddress, string OrgCertaddress, string Image_FileName, string UID)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_insert_tbl_RERA_Project_InternalInfrastructure_Facilities", con);
            ...
            cmd.Parameters.AddWithValue("p_p_ExternalAgency_LocalAuthority_Name", "");//smodel.ExternalAgency_LocalAuthority_Name);
        ...
        public bool Update_Project_InternalInfrastructure_Facilities(ClsPrp_Project_InternalInfrastructure_Facilities smodel)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_update_tbl_RERA_Project_InternalInfrastructure_Facilities", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public List<ClsPrp_Project_InternalInfrastructure_Facilities> Display_Project_InternalInfrastructure_Facilities(Int64 ProjectRegistration_ID)
        {

            connection();
            List<ClsPrp_Project_InternalInfrastructure_Facilities> ProjectFivelist1 = new List<ClsPrp_Project_InternalInfrastructure_Facilities>();

            MySqlCommand cmd = new MySqlCommand("Display_RERA_Project_InternalInfrastructure_Facilities", con);
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ProjectFivelist1.Add(
                       new ClsPrp_Project_InternalInfrastructure_Facilities
                       {
        ...
        public List<ClsPrp_Project_InternalInfrastructure_Facilities> Display_Project_InternalInfrastructure_Facilities(Int64 ProjectRegistration_ID, Int64 Id)
        {

            connection();
            List<ClsPrp_Project_InternalInfrastructure_Facilities> ProjectFivelist1 = new List<ClsPrp_Project_InternalInfrastructure_Facilities>();

            MySqlCommand cmd = new MySqlCommand("Display_RERA_Project_InternalInfrastructure_FacilitiesID", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("p_ProjectInfrastructure_ProjectRegistration_ID", ProjectRegistration_ID);
        ...
        public bool Delete_InternalInFacilities(Int64 ProjectInfrastructure_ProjectRegistration_ID, Int64 ProjectInfrastructureFacilities_IndexID)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("Delete_InternalInfrastructure_Facilities", con);
            cmd.CommandType = CommandType.StoredProcedure;
