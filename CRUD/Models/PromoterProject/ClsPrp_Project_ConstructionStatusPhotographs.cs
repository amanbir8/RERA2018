...
{
    public class ClsPrp_Project_ConstructionStatusPhotographs
    {
        ...
        public List<ClsPrp_Project_ConstructionStatusPhotographs> prpongoing { get; set; }

        public ClsPrp_Project_ConstructionStatusPhotographs()
        {
            prpongoing = new List<ClsPrp_Project_ConstructionStatusPhotographs>();
        }
