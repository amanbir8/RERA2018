...
{
    public class ClsPrp_Project_CoPromoterDetails
    {
        ...
        [StringLength(90, MinimumLength = 2)]
        [RegularExpression(@"^[a-zA-Z''-'-.\s]{1,90}$", ErrorMessage = "Special characters are not allowed. Maximum length is 90")]
        [Display(Name = "Main Objects of Promoter")]
        ...
        public List<ClsPrp_Project_CoPromoterDetails> prpongoing { get; set; }
        public ClsPrp_Project_CoPromoterDetails()
        {
            prpongoing = new List<ClsPrp_Project_CoPromoterDetails>();
        }
