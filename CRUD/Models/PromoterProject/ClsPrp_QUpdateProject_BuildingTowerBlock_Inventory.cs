...
{
    public class ClsPrp_QUpdateProject_BuildingTowerBlock_Inventory
    {
        ...
        public List<ClsPrp_QUpdateProject_BuildingTowerBlock_Inventory> prpongoing { get; set; }
        public ClsPrp_QUpdateProject_BuildingTowerBlock_Inventory()
        {
            prpongoing = new List<ClsPrp_QUpdateProject_BuildingTowerBlock_Inventory>();
