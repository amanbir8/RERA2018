...
{
    public class ClsPrp_Project_KhasraAreaDetails
    {
        ...
        [Display(Name = "Area of Land proposed under Khasra Number (in sqr mtrs)")]
        ...
        [Display(Name = "Name of Villages under Khasra Number")]
        ...
        public List<ClsPrp_Project_KhasraAreaDetails> prpongoing { get; set; }

        public ClsPrp_Project_KhasraAreaDetails()
        {
            prpongoing = new List<ClsPrp_Project_KhasraAreaDetails>();
