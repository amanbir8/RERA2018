...
{
    public class Clsprp_Master_Project_ExtensionFormDocuments
    {
        ...
        public Clsprp_Master_Project_ExtensionFormDocuments()
        {
           new List<Clsprp_Master_Project_ExtensionFormDocuments>();
        }
    }
}