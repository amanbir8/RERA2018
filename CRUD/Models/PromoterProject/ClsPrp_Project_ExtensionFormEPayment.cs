...
{
    public class ClsPrp_Project_ExtensionFormEPayment
    {
        ...
        public List<ClsPrp_Project_ExtensionFormEPayment> prpongoing { get; set; }
        public ClsPrp_Project_ExtensionFormEPayment()
        {
            prpongoing = new List<ClsPrp_Project_ExtensionFormEPayment>();
