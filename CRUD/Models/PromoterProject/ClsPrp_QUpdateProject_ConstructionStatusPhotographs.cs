...
{
    public class ClsPrp_QUpdateProject_ConstructionStatusPhotographs
    {
        ...
        public List<ClsPrp_QUpdateProject_ConstructionStatusPhotographs> prpongoing { get; set; }
        public ClsPrp_QUpdateProject_ConstructionStatusPhotographs()
        {
            prpongoing = new List<ClsPrp_QUpdateProject_ConstructionStatusPhotographs>();
        }
