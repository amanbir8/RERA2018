...
{
    public class ClsPrp_Project_ProfessionalDetails
    {
        ...
        [Display(Name = "State")]
        public int OfficialComm_AddressStateCode { get; set; }

        [Required(ErrorMessage = "The Address District field is required.")]
        [Display(Name = "District")]
        public int OfficialComm_AddressDistrictCode { get; set; }
        ...
        public List<ClsPrp_Project_ProfessionalDetails> prpongoing { get; set; }
        public ClsPrp_Project_ProfessionalDetails()
        {
            prpongoing = new List<ClsPrp_Project_ProfessionalDetails>();
