...
{
    public class ClsMethod_View_CP_ProjectPUCauthorisedprojectperson
    {
        ...
        public Tuple<bool, string> Add_ProjectPUC_AuthorisedProjectPersonDetails(ClsPrp_ControlPanel_View_ProjectPUCAuthorisedPrjPersonDetails smodel, string User_Name, Int64 uProject_ID, Int64 uPromoter_ID, Int64 uPUC_ID, string uProjectDNumber, Int64 uCategoryPUC_ID, string uPucDNumber, string sUID)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_insert_tbl_rera_project_PUC_AuthorisedPrjPersonAdditionals", con);
            cmd.CommandType = CommandType.StoredProcedure;

            #region Parameters
            cmd.Parameters.AddWithValue("p_ProjectPUC_AuthorisedPrjPerson_IndexID", (smodel.ProjectPUC_AuthorisedPrjPerson_IndexID == 0) ? 0 : smodel.ProjectPUC_AuthorisedPrjPerson_IndexID);
            cmd.Parameters.AddWithValue("p_ProjectPUC_AuthorisedPrjPerson_ID", (smodel.ProjectPUC_AuthorisedPrjPerson_ID == 0) ? 0 : smodel.ProjectPUC_AuthorisedPrjPerson_ID);
            ...
            //Properties : Ref Doc of Authorised Person (Project)
            ...
            cmd.Parameters.AddWithValue("p_AuthorizedPerson_MiddleName", String.IsNullOrEmpty(smodel.AuthorizedPerson_MiddleName) ? string.Empty : smodel.AuthorizedPerson_MiddleName);
            ...
            cmd.Parameters.AddWithValue("p_AuthorizedPerson_AddressStateCode", (smodel.AuthorizedPerson_AddressStateCode == 0) ? 0 : smodel.AuthorizedPerson_AddressStateCode);
            cmd.Parameters.AddWithValue("p_AuthorizedPerson_AddressDistrictCode", (smodel.AuthorizedPerson_AddressDistrictCode == 0) ? 0 : smodel.AuthorizedPerson_AddressDistrictCode);
            cmd.Parameters.AddWithValue("p_AuthorizedPerson_AddressPIN", String.IsNullOrEmpty(smodel.AuthorizedPerson_AddressPIN) ? string.Empty : smodel.AuthorizedPerson_AddressPIN);
            cmd.Parameters.AddWithValue("p_AuthorizedPerson_EmailAddress", String.IsNullOrEmpty(smodel.AuthorizedPerson_EmailAddress) ? string.Empty : smodel.AuthorizedPerson_EmailAddress);
            cmd.Parameters.AddWithValue("p_AuthorizedPerson_MobileNumber", (smodel.AuthorizedPerson_MobileNumber == 0) ? 0 : smodel.AuthorizedPerson_MobileNumber);
        ...
        public Tuple<bool, string> Update_ProjectPUC_AuthorisedProjectPersonDetails(ClsPrp_ControlPanel_View_ProjectPUCAuthorisedPrjPersonDetails smodel, string User_Name, Int64 uProject_ID, Int64 uPromoter_ID, Int64 uPUC_ID, string uProjectDNumber, Int64 uCategoryPUC_ID, string uPucDNumber, string sUID)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_update_tbl_rera_project_PUC_AuthorisedPrjPersonAdditionals", con);
            cmd.CommandType = CommandType.StoredProcedure;
