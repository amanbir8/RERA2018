...
{
    public class ClsPrp_ControlPanel_View_Email_Agent
    {
        public long AdditionalAgentEmail_IndexID { get; set; }
        public long AdditionalAgentEmail_ID { get; set; }
        ...
        public List<ClsPrp_ControlPanel_View_Email_Agent> prpongoing { get; set; }
        public ClsPrp_ControlPanel_View_Email_Agent()
        {
            prpongoing = new List<ClsPrp_ControlPanel_View_Email_Agent>();
        }
