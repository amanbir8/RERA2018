...
{
    public class ClsPrp_ControlPanel_View_Mobile_Project
    {
        public long AdditionalProjectMobileNumber_IndexID { get; set; }
        public long AdditionalProjectMobileNumber_ID { get; set; }
        ...
        public List<ClsPrp_ControlPanel_View_Mobile_Project> prpongoing { get; set; }
        public ClsPrp_ControlPanel_View_Mobile_Project()
        {
            prpongoing = new List<ClsPrp_ControlPanel_View_Mobile_Project>();
        }
