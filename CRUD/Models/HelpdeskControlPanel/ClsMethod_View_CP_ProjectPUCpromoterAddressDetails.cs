...
{
    public class ClsMethod_View_CP_ProjectPUCpromoterAddressDetails
    {
        ...
        public Tuple<bool, string> Add_ProjectPUC_PromoterAddressDetails(ClsPrp_ControlPanel_View_ProjectPUCAuthorisedPrmtrPersonDetails smodel, string User_Name, Int64 uProject_ID, Int64 uPromoter_ID, Int64 uPUC_ID, string uProjectDNumber, Int64 uCategoryPUC_ID, string uPucDNumber, string sUID)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_insert_tbl_rera_project_PUC_PromoterAddressAdditionals", con);
            cmd.CommandType = CommandType.StoredProcedure;

            #region Parameters
            cmd.Parameters.AddWithValue("p_ProjectPUC_PromoterAddress_IndexID", (smodel.ProjectPUC_AuthorisedPrmtrPerson_IndexID == 0) ? 0 : smodel.ProjectPUC_AuthorisedPrmtrPerson_IndexID);
            cmd.Parameters.AddWithValue("p_ProjectPUC_PromoterAddress_ID", (smodel.ProjectPUC_AuthorisedPrmtrPerson_ID == 0) ? 0 : smodel.ProjectPUC_AuthorisedPrmtrPerson_ID);
            ...
            //Properties : Ref Doc of Promoter Address
            ...
            //Properties [Start] : Promoter Address
            ...
            cmd.Parameters.AddWithValue("p_Address_Line1", String.IsNullOrEmpty(smodel.Address_Line1) ? string.Empty : smodel.Address_Line1);
            cmd.Parameters.AddWithValue("p_Address_Line2", String.IsNullOrEmpty(smodel.Address_Line2) ? string.Empty : smodel.Address_Line2);
            cmd.Parameters.AddWithValue("p_State", String.IsNullOrEmpty(smodel.State) ? string.Empty : smodel.State);
            cmd.Parameters.AddWithValue("p_District", String.IsNullOrEmpty(smodel.District) ? string.Empty : smodel.District);
            cmd.Parameters.AddWithValue("p_Pin_Code", (smodel.Pin_Code == 0) ? 0 : smodel.Pin_Code);

            cmd.Parameters.AddWithValue("p_Org_Address_Line1", String.IsNullOrEmpty(smodel.Org_Address_Line1) ? string.Empty : smodel.Org_Address_Line1);
            cmd.Parameters.AddWithValue("p_Org_Address_Line2", String.IsNullOrEmpty(smodel.Org_Address_Line2) ? string.Empty : smodel.Org_Address_Line2);
            cmd.Parameters.AddWithValue("p_Org_State", String.IsNullOrEmpty(smodel.Org_State) ? string.Empty : smodel.Org_State);
            cmd.Parameters.AddWithValue("p_Org_District", String.IsNullOrEmpty(smodel.Org_District) ? string.Empty : smodel.Org_District);
            cmd.Parameters.AddWithValue("p_Org_Pin_Code", (smodel.Org_Pin_Code == 0) ? 0 : smodel.Org_Pin_Code);
        ...
        public Tuple<bool, string> Update_ProjectPUC_PromoterAddressDetails(ClsPrp_ControlPanel_View_ProjectPUCAuthorisedPrmtrPersonDetails smodel, string User_Name, Int64 uProject_ID, Int64 uPromoter_ID, Int64 uPUC_ID, string uProjectDNumber, Int64 uCategoryPUC_ID, string uPucDNumber, string sUID)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_update_tbl_rera_project_PUC_PromoterAddressAdditionals", con);
            cmd.CommandType = CommandType.StoredProcedure;
