...
{
    public class ClsPrp_ControlPanel_View_Email_Promoter
    {
        public long AdditionalPromoterEmail_IndexID { get; set; }
        public long AdditionalPromoterEmail_ID { get; set; }
        ...
        public List<ClsPrp_ControlPanel_View_Email_Promoter> prpongoing { get; set; }
        public ClsPrp_ControlPanel_View_Email_Promoter()
        {
            prpongoing = new List<ClsPrp_ControlPanel_View_Email_Promoter>();
        }
