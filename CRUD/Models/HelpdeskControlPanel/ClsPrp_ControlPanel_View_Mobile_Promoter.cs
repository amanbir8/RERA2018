...
{
    public class ClsPrp_ControlPanel_View_Mobile_Promoter
    {
        public long AdditionalPromoterMobileNumber_IndexID { get; set; }
        public long AdditionalPromoterMobileNumber_ID { get; set; }
        ...
        public List<ClsPrp_ControlPanel_View_Mobile_Promoter> prpongoing { get; set; }
        public ClsPrp_ControlPanel_View_Mobile_Promoter()
        {
            prpongoing = new List<ClsPrp_ControlPanel_View_Mobile_Promoter>();
        }
