...
{
    public class ClsPrp_ControlPanel_View_Email_ComplaintFormN
    {
        public long AdditionalEmailFormN_IndexID { get; set; }
        public long AdditionalEmailFormN_ID { get; set; }
        ...
        public List<ClsPrp_ControlPanel_View_Email_ComplaintFormN> prpongoing { get; set; }
        public ClsPrp_ControlPanel_View_Email_ComplaintFormN()
        {
            prpongoing = new List<ClsPrp_ControlPanel_View_Email_ComplaintFormN>();
        }
