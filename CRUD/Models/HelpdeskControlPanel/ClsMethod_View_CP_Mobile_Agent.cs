...
{
    public class ClsMethod_View_CP_Mobile_Agent
    {
        ...
        public List<ClsPrp_ControlPanel_View_Mobile_Agent> Display_CP_AgentRegisteredAgentDetailsForMobileNumber_ByID(string pRegistrationNumber, string pUserRole)
        {
            connection();
            List<ClsPrp_ControlPanel_View_Mobile_Agent> CPregistrationList = new List<ClsPrp_ControlPanel_View_Mobile_Agent>();
            ...
            foreach (DataRow dr in dt.Rows)
            {
                CPregistrationList.Add(
                    new ClsPrp_ControlPanel_View_Mobile_Agent
                    {
        ...
        public List<ClsPrp_ControlPanel_View_Mobile_Agent> Display_CP_MobileNumbersAll_ForRegisteredAgents_ByID(string pRegistrationNumber, string pUserRole)
        {
            connection();
            List<ClsPrp_ControlPanel_View_Mobile_Agent> CPregistrationList = new List<ClsPrp_ControlPanel_View_Mobile_Agent>();

            MySqlCommand cmd = new MySqlCommand("Display_RERA_CP_MobileAgentNumbersAllDetails_ByID", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("p_RegistrationNumber", pRegistrationNumber);
            cmd.Parameters.AddWithValue("p_UserRole", pUserRole);
            MySqlDataAdapter sd = new MySqlDataAdapter(cmd);
            ...
            foreach (DataRow dr in dt.Rows)
            {
                CPregistrationList.Add(
                    new ClsPrp_ControlPanel_View_Mobile_Agent
                    {
                        AdditionalAgentMobileNumber_IndexID = Convert.ToInt64(dr["AdditionalAgentMobileNumber_IndexID"]),
                        AdditionalAgentMobileNumber_ID = Convert.ToInt64(dr["AdditionalAgentMobileNumber_ID"]),
        ...
        public Int32 Update_LockUnlockHandler_CP_MobileNumbersAll_ForRegisteredAgentsByIndex(string RequestID, string RelatedRefIndexID, string RelatedRefID, string RelatedRefYear, string RelatedCode, string LockUnlockCode, string ByUserName, string ByUserID, string RelatedRemarksIfAny, string RelatedPVMsg)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_cp_setlockunlock_agentmobilenumberByIndex", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public Tuple<bool, string> Add_AgentRegisteredAgent_PhoneMobileNumber(ClsPrp_ControlPanel_View_Mobile_Agent smodel, string User_Name, Int64 sAgent_ID, Int64 sRenewalAgent_ID, Int32 sRenewalAgent_Year, string sAgentDiaryNumber, string sUID)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_insert_CP_tbl_rera_agent_additionalmobilenumber_agent", con);
            cmd.CommandType = CommandType.StoredProcedure;
            DateTime dtvalue = new DateTime(0001, 1, 1);

            #region Parameters
            cmd.Parameters.AddWithValue("p_AdditionalAgentMobileNumber_IndexID", (smodel.AdditionalAgentMobileNumber_IndexID == 0) ? 0 : smodel.AdditionalAgentMobileNumber_IndexID);
            cmd.Parameters.AddWithValue("p_AdditionalAgentMobileNumber_ID", (smodel.AdditionalAgentMobileNumber_ID == 0) ? 0 : smodel.AdditionalAgentMobileNumber_ID);
            ...
            cmd.Parameters.AddWithValue("p_AMN_ReferenceDate", smodel.AMN_ReferenceDate.HasValue ? smodel.AMN_ReferenceDate.Value : dtvalue);
