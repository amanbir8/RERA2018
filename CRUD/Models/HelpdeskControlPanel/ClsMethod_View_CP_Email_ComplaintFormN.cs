...
{
    public class ClsMethod_View_CP_Email_ComplaintFormN
    {
        ...
        public List<ClsPrp_ControlPanel_View_Email_ComplaintFormN> Display_CP_FormNcomplaintDetailsForEmailAddress_ByID(string pRegistrationNumber, string pUserRole)
        {
            connection();
            List<ClsPrp_ControlPanel_View_Email_ComplaintFormN> CPregistrationList = new List<ClsPrp_ControlPanel_View_Email_ComplaintFormN>();
            ...
            foreach (DataRow dr in dt.Rows)
            {
                CPregistrationList.Add(
                    new ClsPrp_ControlPanel_View_Email_ComplaintFormN
                    {
        ...
        public List<ClsPrp_ControlPanel_View_Email_ComplaintFormN> Display_CP_EmailsAll_ForRegisteredComplaintFormN_ByID(string pRegistrationNumber, string pUserRole)
        {
            connection();
            List<ClsPrp_ControlPanel_View_Email_ComplaintFormN> CPregistrationList = new List<ClsPrp_ControlPanel_View_Email_ComplaintFormN>();

            MySqlCommand cmd = new MySqlCommand("Display_RERA_CP_EmailsComplaintNFormAddressAllDetails_ByID", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("p_RegistrationNumber", pRegistrationNumber);
            cmd.Parameters.AddWithValue("p_UserRole", pUserRole);
            MySqlDataAdapter sd = new MySqlDataAdapter(cmd);
            ...
            foreach (DataRow dr in dt.Rows)
            {
                CPregistrationList.Add(
                    new ClsPrp_ControlPanel_View_Email_ComplaintFormN
                    {
                        AdditionalEmailFormN_IndexID = Convert.ToInt64(dr["AdditionalEmailFormN_IndexID"]),
                        AdditionalEmailFormN_ID = Convert.ToInt64(dr["AdditionalEmailFormN_ID"]),
                        ComplaintFormN_ID = Convert.ToInt64(dr["ComplaintFormN_ID"]),
                        ComplaintFormN_Code = Convert.ToString(dr["ComplaintFormN_Code"]),
                        Profile_ID = Convert.ToInt64(dr["Profile_ID"]),
                        User_ID = Convert.ToString(dr["User_ID"]),
        ...
        public Int32 Update_LockUnlockHandler_CP_EmailAddressAll_ForRegisteredComplaintNFormByIndex(string RequestID, string RelatedRefIndexID, string RelatedRefID, string RelatedCode, string LockUnlockCode, string ByUserName, string ByUserID, string RelatedRemarksIfAny, string RelatedPVMsg)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_cp_setlockunlock_complaintnformemailaddressByIndex", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public Tuple<bool, string> Add_ComplaintFormN_EmailAddress(ClsPrp_ControlPanel_View_Email_ComplaintFormN smodel, string User_Name, Int64 sFormN_ID, string sFormN_Code, string sFormN_DiaryNumber, string sUID)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_insert_CP_tbl_rera_complaint_formn_additionalemailaddress", con);
            cmd.CommandType = CommandType.StoredProcedure;

            DateTime dtvalue = new DateTime(0001, 1, 1);

            #region Parameters
            cmd.Parameters.AddWithValue("p_AdditionalEmailFormN_IndexID", (smodel.AdditionalEmailFormN_IndexID == 0) ? 0 : smodel.AdditionalEmailFormN_IndexID);
            cmd.Parameters.AddWithValue("p_AdditionalEmailFormN_ID", (smodel.AdditionalEmailFormN_ID == 0) ? 0 : smodel.AdditionalEmailFormN_ID);
