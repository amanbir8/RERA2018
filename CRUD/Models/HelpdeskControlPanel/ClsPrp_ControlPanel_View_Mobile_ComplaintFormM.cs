...
{
    public class ClsPrp_ControlPanel_View_Mobile_ComplaintFormM
    {
        public long AdditionalMobileNumberFormM_IndexID { get; set; }
        public long AdditionalMobileNumberFormM_ID { get; set; }
        ...
        public List<ClsPrp_ControlPanel_View_Mobile_ComplaintFormM> prpongoing { get; set; }
        public ClsPrp_ControlPanel_View_Mobile_ComplaintFormM()
        {
            prpongoing = new List<ClsPrp_ControlPanel_View_Mobile_ComplaintFormM>();
        }
