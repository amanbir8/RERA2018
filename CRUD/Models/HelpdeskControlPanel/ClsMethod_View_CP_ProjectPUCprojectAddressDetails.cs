...
{
    public class ClsMethod_View_CP_ProjectPUCprojectAddressDetails
    {
        ...
        public Tuple<bool, string> Add_ProjectPUC_ProjectAddressDetails(ClsPrp_ControlPanel_View_ProjectPUCAuthorisedPrjPersonDetails smodel, string User_Name, Int64 uProject_ID, Int64 uPromoter_ID, Int64 uPUC_ID, string uProjectDNumber, Int64 uCategoryPUC_ID, string uPucDNumber, string sUID)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_insert_tbl_rera_project_PUC_ProjectAddressAdditionals", con);
            ...
            //Properties : Ref Doc of Project Address
            ...
            //Properties [Start] : Project Address
            ...
            cmd.Parameters.AddWithValue("p_Project_AddressLine1", String.IsNullOrEmpty(smodel.Project_AddressLine1) ? string.Empty : smodel.Project_AddressLine1);
            cmd.Parameters.AddWithValue("p_Project_AddressLine2", String.IsNullOrEmpty(smodel.Project_AddressLine2) ? string.Empty : smodel.Project_AddressLine2);
            cmd.Parameters.AddWithValue("p_Project_AddressStateCode", (smodel.Project_AddressStateCode == 0) ? 0 : smodel.Project_AddressStateCode);
            cmd.Parameters.AddWithValue("p_Project_AddressDistrictCode", (smodel.Project_AddressDistrictCode == 0) ? 0 : smodel.Project_AddressDistrictCode);
            cmd.Parameters.AddWithValue("p_Project_AddressSubDivisionCode", (smodel.Project_AddressSubDivisionCode == 0) ? 0 : smodel.Project_AddressSubDivisionCode);
            cmd.Parameters.AddWithValue("p_Project_AddressPIN", String.IsNullOrEmpty(smodel.Project_AddressPIN) ? string.Empty : smodel.Project_AddressPIN);
            cmd.Parameters.AddWithValue("p_Project_PotentialZoneCode", (smodel.Project_PotentialZoneCode == 0) ? 0 : smodel.Project_PotentialZoneCode);
        ...
        public Tuple<bool, string> Update_ProjectPUC_ProjectAddressDetails(ClsPrp_ControlPanel_View_ProjectPUCAuthorisedPrjPersonDetails smodel, string User_Name, Int64 uProject_ID, Int64 uPromoter_ID, Int64 uPUC_ID, string uProjectDNumber, Int64 uCategoryPUC_ID, string uPucDNumber, string sUID)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_update_tbl_rera_project_PUC_ProjectAddressAdditionals", con);
            cmd.CommandType = CommandType.StoredProcedure;
