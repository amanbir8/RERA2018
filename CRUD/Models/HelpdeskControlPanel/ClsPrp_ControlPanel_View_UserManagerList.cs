...
{
    public class ClsPrp_ControlPanel_View_UserManagerList
    {
        ...
        [EmailAddress]
        [StringLength(250, ErrorMessage = "Maximum length is 250")]
        public string InputEntry_EmailAddress { get; set; }
        [Required]
        [Display(Name = "User Name")]
        [StringLength(250, ErrorMessage = "Maximum length is 250")]
        public string InputEntry_UserName { get; set; }


        public List<ClsPrp_ControlPanel_View_UserManagerList> prpongoing { get; set; }
        public ClsPrp_ControlPanel_View_UserManagerList()
        {
            prpongoing = new List<ClsPrp_ControlPanel_View_UserManagerList>();
        }
    }
}