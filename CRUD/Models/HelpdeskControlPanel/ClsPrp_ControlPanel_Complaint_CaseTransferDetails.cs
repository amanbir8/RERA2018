...
{
    public class ClsPrp_ControlPanel_Complaint_CaseTransferDetails
    {
        ...
        [Display(Name = "Follow-up before (Yes/No)")]
        public int IsFollowUpBefore { get; set; }
        ...
        public List<ClsPrp_ControlPanel_Complaint_CaseTransferDetails> prpongoing { get; set; }
        public ClsPrp_ControlPanel_Complaint_CaseTransferDetails()
        {
            prpongoing = new List<ClsPrp_ControlPanel_Complaint_CaseTransferDetails>();
        }
