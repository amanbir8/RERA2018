...
{
    public class ClsPrp_ControlPanel_View_Mobile_ComplaintFormN
    {
        public long AdditionalMobileNumberFormN_IndexID { get; set; }
        public long AdditionalMobileNumberFormN_ID { get; set; }
        ...
        public List<ClsPrp_ControlPanel_View_Mobile_ComplaintFormN> prpongoing { get; set; }
        public ClsPrp_ControlPanel_View_Mobile_ComplaintFormN()
        {
            prpongoing = new List<ClsPrp_ControlPanel_View_Mobile_ComplaintFormN>();
        }
