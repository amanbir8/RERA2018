...
{
    public class ClsPrp_AgentRenewalApplication_PaymentIntegration
    {
        public long PaymentRefNumberRenewalAgent_IndexID { get; set; }
        public long PaymentRefNumberRenewalAgent_ID { get; set; }
        ...
        [Display(Name = "Status")]
        public string Agent_BriefSummary { get; set; }
        ...
        public List<ClsPrp_AgentRenewalApplication_PaymentIntegration> AgentRenewalPayment { get; set; }
        public ClsPrp_AgentRenewalApplication_PaymentIntegration()
        {
            AgentRenewalPayment = new List<ClsPrp_AgentRenewalApplication_PaymentIntegration>();
        }

        public List<ClsPrp_StateMaster> stateMaster { get; set; }        
        public List<ClsPrp_DistrictMaster> districtMaster { get; set; }

        public List<ClsPrp_AgentRenewalApplication_Ind_OTInd> AgentRenewalApplication_Profile { get; set; }
    }
}