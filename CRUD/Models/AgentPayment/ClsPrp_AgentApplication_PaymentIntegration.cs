...
{
    public class ClsPrp_AgentApplication_PaymentIntegration
    {
        ...
        public List<ClsPrp_AgentApplication_PaymentIntegration> AgentPayment { get; set; }
        public ClsPrp_AgentApplication_PaymentIntegration()
        {
            AgentPayment = new List<ClsPrp_AgentApplication_PaymentIntegration>();
        }

        public List<ClsPrp_StateMaster> stateMaster { get; set; }        
        public List<ClsPrp_DistrictMaster> districtMaster { get; set; }

        public List<ClsPrp_AgentApplication_Ind_OTInd> AgentApplication_Profile { get; set; }
    }
}