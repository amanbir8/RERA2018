...
{
    public class ClsPrpAgentReverify
    {
        ...
        public List<ClsPrpAgentReverify> AgentPayment { get; set; }
        public ClsPrpAgentReverify()
        {
            AgentPayment = new List<ClsPrpAgentReverify>();
        }
