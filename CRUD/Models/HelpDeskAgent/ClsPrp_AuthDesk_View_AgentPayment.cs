...
{
    public class ClsPrp_AuthDesk_View_AgentPayment
    {
        ...
        public int IsDraftAgentPayment { get; set; }
        ...
        public List<ClsPrp_AuthDesk_View_AgentPayment> AgentPayment { get; set; }

        public ClsPrp_AuthDesk_View_AgentPayment()
        {
            AgentPayment = new List<ClsPrp_AuthDesk_View_AgentPayment>();
        }
        ...
        public List<ClsPrp_AuthDesk_View_AgentPaymentIntegration> AgentPaymentWithTranasactions { get; set; }
    }
}