...
{
    public class ClsPrp_AuthDesk_View_RenewalAgent_OtherIndProfile
    {
        ...
        public int IsDraftOtherMember { get; set; }
        ...
        public List<ClsPrp_AuthDesk_View_RenewalAgent_OtherIndProfile> AgentOtherIndProfile { get; set; }
        public ClsPrp_AuthDesk_View_RenewalAgent_OtherIndProfile()
        {
            AgentOtherIndProfile = new List<ClsPrp_AuthDesk_View_RenewalAgent_OtherIndProfile>();
        }

        public List<ClsPrp_AuthDesk_View_RenewalAgent_OtherMembers> Agent_OtherMember { get; set; }
    }
}