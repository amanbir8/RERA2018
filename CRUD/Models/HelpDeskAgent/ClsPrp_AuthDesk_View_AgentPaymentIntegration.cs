...
{
    public class ClsPrp_AuthDesk_View_AgentPaymentIntegration
    {
        ...
        public List<ClsPrp_AuthDesk_View_AgentPaymentIntegration> AgentPaymentTranasactions { get; set; }
        public ClsPrp_AuthDesk_View_AgentPaymentIntegration()
        {
            AgentPaymentTranasactions = new List<ClsPrp_AuthDesk_View_AgentPaymentIntegration>();
        }
