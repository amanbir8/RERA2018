...
{
    public class ClsPrp_AuthDesk_View_RenewalAgent_PaymentIntegration
    {
        ...
        public List<ClsPrp_AuthDesk_View_RenewalAgent_PaymentIntegration> AgentPaymentTranasactions { get; set; }
        public ClsPrp_AuthDesk_View_RenewalAgent_PaymentIntegration()
        {
            AgentPaymentTranasactions = new List<ClsPrp_AuthDesk_View_RenewalAgent_PaymentIntegration>();
        }
