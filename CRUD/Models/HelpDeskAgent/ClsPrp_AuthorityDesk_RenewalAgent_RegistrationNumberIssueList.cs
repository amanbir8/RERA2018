...
{
    public class ClsPrp_AuthorityDesk_RenewalAgent_RegistrationNumberIssueList
    {
        public long RenewalAgent_IssueRefNumber_DiaryNumber_IndexID { get; set; }
        public long RenewalAgent_IssueRefNumber_DiaryNumber_ID { get; set; }
        ...
        public List<ClsPrp_AuthorityDesk_RenewalAgent_RegistrationNumberIssueList> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_RenewalAgent_RegistrationNumberIssueList()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_RenewalAgent_RegistrationNumberIssueList>();
        }        
    }
}