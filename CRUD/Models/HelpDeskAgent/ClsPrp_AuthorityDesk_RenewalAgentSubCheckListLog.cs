...
{
    public class ClsPrp_AuthorityDesk_RenewalAgentSubCheckListLog
    {
        ...
        public List<ClsPrp_AuthorityDesk_RenewalAgentSubCheckListLog> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_RenewalAgentSubCheckListLog()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_RenewalAgentSubCheckListLog>();
        }
