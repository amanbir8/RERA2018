...
{
    public class ClsPrp_AuthorityDesk_RevocationCancellationAgentDiaryNumberToExcel
    {
        ...
        public List<ClsPrp_AuthorityDesk_RevocationCancellationAgentDiaryNumberToExcel> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_RevocationCancellationAgentDiaryNumberToExcel()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_RevocationCancellationAgentDiaryNumberToExcel>();
        }        
    }
}