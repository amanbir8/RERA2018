...
{
    public class ClsPrp_AuthDesk_View_AgentDocuments
    {
        ...
        public int parmRelated_AgentType_ID { get; set; }
        public int IsDraftAgentListDocuments { get; set; }
        ...
        public List<ClsPrp_AuthDesk_View_AgentDocuments> AgentDocs { get; set; }

        public ClsPrp_AuthDesk_View_AgentDocuments()
        {
            AgentDocs = new List<ClsPrp_AuthDesk_View_AgentDocuments>();
        }
    }
}