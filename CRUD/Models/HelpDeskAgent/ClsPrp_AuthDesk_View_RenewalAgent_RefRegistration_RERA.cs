...
{
    public class ClsPrp_AuthDesk_View_RenewalAgent_RefRegistration_RERA
    {
        public long AgentRenewal_RefRegistration_regRERA_IndexID { get; set; }
        public long AgentRenewal_RefRegistration_regRERA_ID { get; set; }
        ...
        public List<ClsPrp_AuthDesk_View_RenewalAgent_RefRegistration_RERA> Agent_RefRegistrationsRERA { get; set; }
        public ClsPrp_AuthDesk_View_RenewalAgent_RefRegistration_RERA()
        {
            Agent_RefRegistrationsRERA = new List<ClsPrp_AuthDesk_View_RenewalAgent_RefRegistration_RERA>();
        }        
    }
}