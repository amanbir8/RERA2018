...
{
    public class ClsPrp_AuthDesk_View_RenewalAgent_Payment
    {
        ...
        public int IsDraftRenewalAgentPayment { get; set; }
        ...
        public List<ClsPrp_AuthDesk_View_RenewalAgent_Payment> AgentPayment { get; set; }
        public ClsPrp_AuthDesk_View_RenewalAgent_Payment()
        {
            AgentPayment = new List<ClsPrp_AuthDesk_View_RenewalAgent_Payment>();
        }

        public List<ClsPrp_AuthDesk_View_RenewalAgent_PaymentIntegration> AgentPaymentWithTranasactions { get; set; }
    }
}