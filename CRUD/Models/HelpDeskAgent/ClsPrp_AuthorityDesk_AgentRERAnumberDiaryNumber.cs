...
{
    public class ClsPrp_AuthorityDesk_AgentRERAnumberDiaryNumber
    {
        ...
        public List<ClsPrp_AuthorityDesk_AgentRERAnumberDiaryNumber> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_AgentRERAnumberDiaryNumber()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_AgentRERAnumberDiaryNumber>();
