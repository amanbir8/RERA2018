...
{
    public class ClsPrp_AuthDesk_View_AgentIndProfile
    {
        ...
        public List<ClsPrp_AuthDesk_View_AgentIndProfile> AgentIndProfile { get; set; }
        public ClsPrp_AuthDesk_View_AgentIndProfile()
        {
            AgentIndProfile = new List<ClsPrp_AuthDesk_View_AgentIndProfile>();
        }
    }
}