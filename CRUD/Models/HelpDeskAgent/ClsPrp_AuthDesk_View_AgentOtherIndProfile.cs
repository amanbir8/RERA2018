...
{
    public class ClsPrp_AuthDesk_View_AgentOtherIndProfile
    {
        ...
        public int IsDraftAgentProfile { get; set; }
        public int IsDraftAgentOtherMember { get; set; }
        ...
        public List<ClsPrp_AuthDesk_View_AgentOtherIndProfile> AgentOtherIndProfile { get; set; }
        public ClsPrp_AuthDesk_View_AgentOtherIndProfile()
        {
            AgentOtherIndProfile = new List<ClsPrp_AuthDesk_View_AgentOtherIndProfile>();
        }

        public List<ClsPrp_AuthDesk_View_AgentOtherMembers> Agent_OtherMember { get; set; }
    }
}