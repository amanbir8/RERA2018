...
{
    public class ClsPrp_AuthDesk_View_RenewalAgent_Documents
    {
        public long RenewalAgent_Document_IndexID { get; set; }
        public long RenewalAgent_Document_ID { get; set; }
        ...
        public long Related_RenewalAgentDoc_ID { get; set; }
        ...
        public int IsDraftRenewalAgentListDocuments { get; set; }
        ...
        public List<ClsPrp_AuthDesk_View_RenewalAgent_Documents> AgentDocs { get; set; }

        public ClsPrp_AuthDesk_View_RenewalAgent_Documents()
        {
            AgentDocs = new List<ClsPrp_AuthDesk_View_RenewalAgent_Documents>();
        }
    }
}