...
{
    public class ClsPrp_AuthDesk_View_RenewalAgent_OtherMembers
    {
        ...
        public string OfficeComm_AddressStateName { get; set; }
        public string OfficeComm_AddressDistName { get; set; }
