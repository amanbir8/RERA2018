...
{
    public class ClsPrp_ProjectPmApplication_PaymentIntegration
    {
        ...
        public List<ClsPrp_ProjectPmApplication_PaymentIntegration> ProjectPmPayment { get; set; }
        public ClsPrp_ProjectPmApplication_PaymentIntegration()
        {
            ProjectPmPayment = new List<ClsPrp_ProjectPmApplication_PaymentIntegration>();
        }

        public List<ClsPrp_StateMaster> stateMaster { get; set; }        
        public List<ClsPrp_DistrictMaster> districtMaster { get; set; }

        public List<ClsPrp_ProjectPmApplication_Registration> ProjectPmApplication_Registration { get; set; }
    }
}