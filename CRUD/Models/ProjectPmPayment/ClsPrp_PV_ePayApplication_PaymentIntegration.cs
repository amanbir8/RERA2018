...
{
    public class ClsPrp_PV_ePayApplication_PaymentIntegration
    {
        public long PaymentGatewayPay_IndexID { get; set; }
        public long PaymentGatewayPay_ID { get; set; }
        public long Related_PaymentRegistration_ID { get; set; }
        public long Related_Payment_epayTxnID { get; set; }
        public string Related_Payment_epayTxnNumber { get; set; }
        public long Related_Payment_epayChallanID { get; set; }
        public string Related_Payment_epayChallanNumber { get; set; }
        public string Related_Payment_ReferenceNumber { get; set; }
        public string Related_RERAnumberRegistration { get; set; }

        public int PaymentGatewayFlag { get; set; }
        ...
        [Display(Name = "Status")]
        public string ePay_BriefSummary { get; set; }
        ...
        public List<ClsPrp_PV_ePayApplication_PaymentIntegration> ePayPayment { get; set; }
        public ClsPrp_PV_ePayApplication_PaymentIntegration()
        {
            ePayPayment = new List<ClsPrp_PV_ePayApplication_PaymentIntegration>();
        }
    }
}