...
{
    public class ClsPrp_DashboardDesk_LiveAgentsSubSeries
    {
        ...
        public List<ClsPrp_DashboardDesk_LiveAgentsSubSeries> prpLiveAgentsSubSeries { get; set; }
        public ClsPrp_DashboardDesk_LiveAgentsSubSeries()
        {
            prpLiveAgentsSubSeries = new List<ClsPrp_DashboardDesk_LiveAgentsSubSeries>();
        }
    }
}