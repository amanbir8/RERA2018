...
{
    public class ClsPrp_PrmProject_Print_ProjectExternalInfrastructure_Facilities
    {
        ...
        [Display(Name = "External Infrastructure Facilities Details")]
        ...
        public List<ClsPrp_PrmProject_Print_ProjectExternalInfrastructure_Facilities> prpongoing { get; set; }
        public ClsPrp_PrmProject_Print_ProjectExternalInfrastructure_Facilities()
        {
            prpongoing = new List<ClsPrp_PrmProject_Print_ProjectExternalInfrastructure_Facilities>();
