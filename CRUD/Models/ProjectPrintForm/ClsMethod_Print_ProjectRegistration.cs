...
{
    public class ClsMethod_Print_ProjectRegistration
    {
        ...
        public List<ClsPrp_PrmProject_Print_ProjectRegistration> Display_Project_RegistrationAll(Int64 zProject_ID)
        {
            connection();
            List<ClsPrp_PrmProject_Print_ProjectRegistration> ProjectFivelist1 = new List<ClsPrp_PrmProject_Print_ProjectRegistration>();

            MySqlCommand cmd = new MySqlCommand("Display_RERA_Project_Registration_ForPrint", con);
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ProjectFivelist1.Add(
                       new ClsPrp_PrmProject_Print_ProjectRegistration
                       {
        ...
        public List<ClsPrp_PrmProject_Print_ProjectTypeRegistration> Display_Project_RegistrationTypeProject(Int64 ProjectRegistration_ID)
        {
            connection();
            List<ClsPrp_PrmProject_Print_ProjectTypeRegistration> ProjectFivelist1 = new List<ClsPrp_PrmProject_Print_ProjectTypeRegistration>();

            MySqlCommand cmd = new MySqlCommand("Display_RERA_Project_RegistrationTypeProject_ForPrint", con);            
            ...
            {
                ProjectFivelist1.Add(
                       new ClsPrp_PrmProject_Print_ProjectTypeRegistration
                       {
        ...
        public List<ClsPrp_PrmProject_Print_ProjectPayment> Display_Project_Payment(Int64 ProjectRegistration_ID)
        {
            connection();

            List<ClsPrp_PrmProject_Print_ProjectPayment> ProjectFivelist1 = new List<ClsPrp_PrmProject_Print_ProjectPayment>();

            MySqlCommand cmd = new MySqlCommand("Display_RERA_Project_Payment_ForPrint", con);
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            {
                ProjectFivelist1.Add(
                       new ClsPrp_PrmProject_Print_ProjectPayment
                       {
        ...
        public List<ClsPrp_PrmProject_Print_PaymentIntegration> Display_Print_ProjectApplicationPaymentTransactions(Int64 ProjectRegistration_ID)
        {
            connection();
            List<ClsPrp_PrmProject_Print_PaymentIntegration> Application_List = new List<ClsPrp_PrmProject_Print_PaymentIntegration>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_Project_PaymentGatewayDetails_ForPrint", con);
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            foreach (DataRow dr in dt.Rows)
            {
                Application_List.Add(
                       new ClsPrp_PrmProject_Print_PaymentIntegration
                       {
