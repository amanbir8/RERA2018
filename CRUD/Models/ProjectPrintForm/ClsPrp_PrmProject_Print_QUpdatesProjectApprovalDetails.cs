...
{
    public class ClsPrp_PrmProject_Print_QUpdatesProjectApprovalDetails
    {
        ...
        public List<ClsPrp_PrmProject_Print_QUpdatesProjectApprovalDetails> prpongoing { get; set; }
        public ClsPrp_PrmProject_Print_QUpdatesProjectApprovalDetails()
        {
            prpongoing = new List<ClsPrp_PrmProject_Print_QUpdatesProjectApprovalDetails>();
        }
