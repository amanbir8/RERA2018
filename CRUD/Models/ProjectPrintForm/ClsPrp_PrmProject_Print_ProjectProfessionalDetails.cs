...
{
    public class ClsPrp_PrmProject_Print_ProjectProfessionalDetails
    {
        ...
        public List<ClsPrp_PrmProject_Print_ProjectProfessionalDetails> prpongoing { get; set; }
        public ClsPrp_PrmProject_Print_ProjectProfessionalDetails()
        {
            prpongoing = new List<ClsPrp_PrmProject_Print_ProjectProfessionalDetails>();
