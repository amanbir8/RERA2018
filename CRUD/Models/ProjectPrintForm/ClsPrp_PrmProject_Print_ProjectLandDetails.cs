...
{
    public class ClsPrp_PrmProject_Print_ProjectLandDetails
    {
        ...
        [Display(Name = "Area of Land Under Residential Group Housing")]
        public double ProposedLand_Area_ResidentialGroupHousing { get; set; }

        [Required]
        [RegularExpression(@"^\d+.?\d{0,4}$", ErrorMessage = "Invalid Area; Maximum Four Decimal Points.")]
        [Range(0, 999999999999.9999)]
        [Display(Name = "Area of Land Under Residential Plotted")]
        public double ProposedLand_Area_ResidentialPlotted { get; set; }

        [Required]
        [RegularExpression(@"^\d+.?\d{0,4}$", ErrorMessage = "Invalid Area; Maximum Four Decimal Points.")]
        [Range(0, 999999999999.9999)]
        [Display(Name = "Area of Land Under Commercial")]
        public double ProposedLand_Area_Commercial { get; set; }

        [Required]
        [RegularExpression(@"^\d+.?\d{0,4}$", ErrorMessage = "Invalid Area; Maximum Four Decimal Points.")]
        [Range(0, 999999999999.9999)]
        [Display(Name = "Area of Land Under Industrial")]
        public double ProposedLand_Area_Industrial { get; set; }

        [RegularExpression(@"^\d+.?\d{0,4}$", ErrorMessage = "Invalid Area; Maximum Four Decimal Points.")]
        [Range(0, 999999999999.9999)]
        [Display(Name = "Area of Land Under Common Area")]
        public double ProposedLand_Area_A_column { get; set; }

        [Required]
        [RegularExpression(@"^\d+.?\d{0,4}$", ErrorMessage = "Invalid Area; Maximum Four Decimal Points.")]
        [Range(0, 999999999999.9999)]
        [Display(Name = "Area of Land Under Institution, Club, School and Reserved Area development")]
        public double ProposedLand_Area_B_column { get; set; }

        [Required]
        [RegularExpression(@"^\d+.?\d{0,4}$", ErrorMessage = "Invalid Area; Maximum Four Decimal Points.")]
        [Range(0, 999999999999.9999)]
        [Display(Name = "Area of Land Under EWS development")]
        ...
        public List<ClsPrp_PrmProject_Print_ProjectLandDetails> prpongoing { get; set; }

        public ClsPrp_PrmProject_Print_ProjectLandDetails()
        {
            prpongoing = new List<ClsPrp_PrmProject_Print_ProjectLandDetails>();
