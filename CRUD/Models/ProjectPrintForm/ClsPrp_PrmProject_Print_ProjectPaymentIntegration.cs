...
{
    public class ClsPrp_PrmProject_Print_PaymentIntegration
    {
        ...
        public List<ClsPrp_PrmProject_Print_PaymentIntegration> PrmProjectPaymentTranasactions { get; set; }
        public ClsPrp_PrmProject_Print_PaymentIntegration()
        {
            PrmProjectPaymentTranasactions = new List<ClsPrp_PrmProject_Print_PaymentIntegration>();
        }
