...
{
    public class ClsPrp_PrmProject_Print_QUpdatesProjectInternalInfrastructure_Facilities
    {
        ...
        public List<ClsPrp_PrmProject_Print_QUpdatesProjectInternalInfrastructure_Facilities> prpongoing { get; set; }
        public ClsPrp_PrmProject_Print_QUpdatesProjectInternalInfrastructure_Facilities()
        {
            prpongoing = new List<ClsPrp_PrmProject_Print_QUpdatesProjectInternalInfrastructure_Facilities>();
        }
