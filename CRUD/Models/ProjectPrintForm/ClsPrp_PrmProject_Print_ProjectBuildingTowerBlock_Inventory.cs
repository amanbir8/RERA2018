...
{
    public class ClsPrp_PrmProject_Print_ProjectBuildingTowerBlock_Inventory
    {
        ...
        [Required]
        [Display(Name = "Number of Apartment/Shop/Plot available for Sale")]
        [Range(0, 50000)]
        ...
        public List<ClsPrp_PrmProject_Print_ProjectBuildingTowerBlock_Inventory> prpongoing { get; set; }
        public ClsPrp_PrmProject_Print_ProjectBuildingTowerBlock_Inventory()
        {
            prpongoing = new List<ClsPrp_PrmProject_Print_ProjectBuildingTowerBlock_Inventory>();
