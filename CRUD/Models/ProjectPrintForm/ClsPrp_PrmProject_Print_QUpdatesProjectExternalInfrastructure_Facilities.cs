...
{
    public class ClsPrp_PrmProject_Print_QUpdatesProjectExternalInfrastructure_Facilities
    {
        ...
        public List<ClsPrp_PrmProject_Print_QUpdatesProjectExternalInfrastructure_Facilities> prpongoing { get; set; }
        public ClsPrp_PrmProject_Print_QUpdatesProjectExternalInfrastructure_Facilities()
        {
            prpongoing = new List<ClsPrp_PrmProject_Print_QUpdatesProjectExternalInfrastructure_Facilities>();
        }
