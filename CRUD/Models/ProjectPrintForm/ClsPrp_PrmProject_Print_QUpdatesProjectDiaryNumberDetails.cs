...
{
    public class ClsPrp_PrmProject_Print_QUpdatesProjectDiaryNumberDetails
    {
        ...
        public List<ClsPrp_PrmProject_Print_QUpdatesProjectDiaryNumberDetails> prpongoing { get; set; }

        public ClsPrp_PrmProject_Print_QUpdatesProjectDiaryNumberDetails()
        {
            prpongoing = new List<ClsPrp_PrmProject_Print_QUpdatesProjectDiaryNumberDetails>();
        }
    }
}