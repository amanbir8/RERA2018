...
{
    public class ClsPrp_PrmProject_Print_ProjectConstructionStatusPhotographs
    {
        ...
        public List<ClsPrp_PrmProject_Print_ProjectConstructionStatusPhotographs> prpongoing { get; set; }

        public ClsPrp_PrmProject_Print_ProjectConstructionStatusPhotographs()
        {
            prpongoing = new List<ClsPrp_PrmProject_Print_ProjectConstructionStatusPhotographs>();
        }
