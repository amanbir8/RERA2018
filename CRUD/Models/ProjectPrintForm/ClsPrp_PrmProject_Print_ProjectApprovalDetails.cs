...
{
    public class ClsPrp_PrmProject_Print_ProjectApprovalDetails
    {
        ...
        public List<ClsPrp_PrmProject_Print_ProjectApprovalDetails> prpongoing { get; set; }
        public ClsPrp_PrmProject_Print_ProjectApprovalDetails()
        {
            prpongoing = new List<ClsPrp_PrmProject_Print_ProjectApprovalDetails>();
