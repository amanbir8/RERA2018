...
{
    public class ClsPrp_PrmProject_Print_ProjectRegistration
    {
        ...
        [Required(ErrorMessage = "The Select Option (Existing RERA Project/ New Project) field is required.")]
        ...
        [Required]
        [DisplayFormat(DataFormatString = "{0:dd-MMM-yyyy}", ApplyFormatInEditMode = true)]
        [Display(Name = "Proposed/ Expected Date of Project Completion")]
        ...
        public List<ClsPrp_PrmProject_Print_ProjectRegistration> prpongoing { get; set; }      
        public ClsPrp_PrmProject_Print_ProjectRegistration()
        {
            prpongoing = new List<ClsPrp_PrmProject_Print_ProjectRegistration>();

        }

        public List<ClsPrp_PrmProject_Print_ProjectTypeRegistration> ProjectType_Registration { get; set; }
