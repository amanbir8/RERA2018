...
{
    public class ClsPrp_PrmProject_Print_ProjectLitigations
    {
        ...
        public List<ClsPrp_PrmProject_Print_ProjectLitigations> prpongoing { get; set; }
        public ClsPrp_PrmProject_Print_ProjectLitigations()
        {
            prpongoing = new List<ClsPrp_PrmProject_Print_ProjectLitigations>();
