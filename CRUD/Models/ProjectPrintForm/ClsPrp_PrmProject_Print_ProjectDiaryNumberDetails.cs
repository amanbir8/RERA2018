...
{
    public class ClsPrp_PrmProject_Print_ProjectDiaryNumberDetails
    {
        ...
        public List<ClsPrp_PrmProject_Print_ProjectDiaryNumberDetails> prpongoing { get; set; }

        public ClsPrp_PrmProject_Print_ProjectDiaryNumberDetails()
        {
            prpongoing = new List<ClsPrp_PrmProject_Print_ProjectDiaryNumberDetails>();
