...
{
    public class ClsPrp_Print_FormN_Registration
    {
        ...
        public List<ClsPrp_Print_FormN_Registration> prpComplaintFormN { get; set; }
        public ClsPrp_Print_FormN_Registration()
        {
            prpComplaintFormN = new List<ClsPrp_Print_FormN_Registration>();
        }
        public List<ClsPrp_StateMaster> stateMaster { get; set; }        
        public List<ClsPrp_DistrictMaster> districtMaster { get; set; }

        public List<ClsPrp_Print_FormN_Fee> prpComplaintFormN_FeeDetail { get; set; }
        public List<Clsprp_Print_FormN_Documents> prpComplaintFormN_Docs { get; set; }

        public List<ClsPrp_Print_FormMN_AddMore_Complainant> prpComplaintFormN_AddMoreComplainant { get; set; }
        public List<ClsPrp_Print_FormMN_AddMore_Respondent> prpComplaintFormN_AddMoreRespondent { get; set; }

        public List<ClsPrp_AuthorityDesk_FormN_FactsCaseDocument> FactsCase_Documents { get; set; }
    }
}