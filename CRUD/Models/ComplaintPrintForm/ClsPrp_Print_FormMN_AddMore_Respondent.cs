...
{
    public class ClsPrp_Print_FormMN_AddMore_Respondent
    {
        ...
        public List<ClsPrp_Print_FormMN_AddMore_Respondent> FormMN_Respondent { get; set; }
        public ClsPrp_Print_FormMN_AddMore_Respondent()
        {
            FormMN_Respondent = new List<ClsPrp_Print_FormMN_AddMore_Respondent>();
        }
    }
}