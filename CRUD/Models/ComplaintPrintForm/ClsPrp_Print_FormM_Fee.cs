...
{
    public class ClsPrp_Print_FormM_Fee
    {
        ...
        public List<ClsPrp_Print_FormM_Fee> prpComplaintFormM_Fee { get; set; }
        public ClsPrp_Print_FormM_Fee()
        {
            prpComplaintFormM_Fee = new List<ClsPrp_Print_FormM_Fee>();
        }        
    }
}