...
{
    public class ClsPrp_Print_FormExe_AddMore_Complainant
    {
        ...
        public List<ClsPrp_Print_FormExe_AddMore_Complainant> FormExe_Complainant { get; set; }
        public ClsPrp_Print_FormExe_AddMore_Complainant()
        {
            FormExe_Complainant = new List<ClsPrp_Print_FormExe_AddMore_Complainant>();
        }
    }
}