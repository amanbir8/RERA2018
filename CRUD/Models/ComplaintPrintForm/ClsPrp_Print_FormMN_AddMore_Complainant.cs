...
{
    public class ClsPrp_Print_FormMN_AddMore_Complainant
    {
        ...
        public List<ClsPrp_Print_FormMN_AddMore_Complainant> FormMN_Complainant { get; set; }
        public ClsPrp_Print_FormMN_AddMore_Complainant()
        {
            FormMN_Complainant = new List<ClsPrp_Print_FormMN_AddMore_Complainant>();
        }
    }
}