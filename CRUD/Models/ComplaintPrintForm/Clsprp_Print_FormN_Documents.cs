...
{
    public class Clsprp_Print_FormN_Documents
    {
        ...
        public List<Clsprp_Print_FormN_Documents> prpFormN_Docs { get; set; }
        public Clsprp_Print_FormN_Documents()
        {
            prpFormN_Docs = new List<Clsprp_Print_FormN_Documents>();
        }
    }
}