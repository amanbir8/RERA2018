...
{
    public class ClsMethod_PrintComplaintFormM_Documents
    {
        ...
        public List<Clsprp_Print_FormM_Documents> Display_ComplaintFormM_Documents_ByComplaintFormMID_ForPrint(Int64? ComplaintFormM_ID)
        {
            connection();
            List<Clsprp_Print_FormM_Documents> ComplaintFormM_Documents = new List<Clsprp_Print_FormM_Documents>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_FormM_Documents_ForPrint", con);
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ComplaintFormM_Documents.Add(
                    new Clsprp_Print_FormM_Documents
                    {
        ...
        public List<Clsprp_Print_FormM_Documents> Display_ComplaintFormM_Documents_ByComplaintFormMIDbyProfileID_ForPrint(Int64? ComplaintFormM_ID, Int64? ProfileFormM_ID)
        {
            connection();
            List<Clsprp_Print_FormM_Documents> ComplaintFormM_Documents = new List<Clsprp_Print_FormM_Documents>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_FormM_DocumentsByID_ForPrint", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("p_ComplaintFormM_ID", ComplaintFormM_ID);
        ...
        public List<Clsprp_ExecutionForm_Documents> Display_ComplaintFormExe_Documents_ByComplaintFormMID_ForPrint(Int64? ComplaintForm_ID)
        {
            connection();
            List<Clsprp_ExecutionForm_Documents> ComplaintFormM_Documents = new List<Clsprp_ExecutionForm_Documents>();

            try
            {
                MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_FormExe_Documents_ForPrint", con);
                cmd.CommandType = CommandType.StoredProcedure;
