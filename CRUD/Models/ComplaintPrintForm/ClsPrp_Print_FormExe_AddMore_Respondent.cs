...
{
    public class ClsPrp_Print_FormExe_AddMore_Respondent
    {
        ...
        public List<ClsPrp_Print_FormExe_AddMore_Respondent> FormExe_Respondent { get; set; }
        public ClsPrp_Print_FormExe_AddMore_Respondent()
        {
            FormExe_Respondent = new List<ClsPrp_Print_FormExe_AddMore_Respondent>();
        }
    }
}