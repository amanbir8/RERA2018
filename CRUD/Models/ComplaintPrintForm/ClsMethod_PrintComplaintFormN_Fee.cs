...
{
    public class ClsMethod_PrintComplaintFormN_Fee
    {
        ...
        public List<ClsPrp_Print_FormN_Fee> Display_ComplaintFormN_Payment_ForPrint(Int64 ComplaintFormN_ID)
        {
            connection();
            List<ClsPrp_Print_FormN_Fee> ComplaintFormN_List = new List<ClsPrp_Print_FormN_Fee>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_FormN_Fee_ForPrint", con);
        ...
        public List<ClsPrp_Print_FormN_Fee> Display_ComplaintFormN_PaymentByID_ForPrint(Int64 ComplaintFormN_ID, Int64? ProfileFormN_ID)
        {
            connection();
            List<ClsPrp_Print_FormN_Fee> ComplaintFormN_List = new List<ClsPrp_Print_FormN_Fee>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_FormN_FeeByID_ForPrint", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("p_ComplaintFormN_ID", ComplaintFormN_ID);
