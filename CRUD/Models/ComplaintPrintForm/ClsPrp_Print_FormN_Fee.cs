...
{
    public class ClsPrp_Print_FormN_Fee
    {
        ...
        public List<ClsPrp_Print_FormN_Fee> prpComplaintFormN_Fee { get; set; }
        public ClsPrp_Print_FormN_Fee()
        {
            prpComplaintFormN_Fee = new List<ClsPrp_Print_FormN_Fee>();
        }        
    }
}