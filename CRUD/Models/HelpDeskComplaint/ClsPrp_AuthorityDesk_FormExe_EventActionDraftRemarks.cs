...
{
    public class ClsPrp_AuthorityDesk_FormExe_EventActionSaveAsDraftRemarks
    {
        public long ComplaintFormExe_EventActionDraft_ID { get; set; }
        [Required]
        ...
        public List<ClsPrp_AuthorityDesk_FormExe_EventActionSaveAsDraftRemarks> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_FormExe_EventActionSaveAsDraftRemarks()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_FormExe_EventActionSaveAsDraftRemarks>();
        }
