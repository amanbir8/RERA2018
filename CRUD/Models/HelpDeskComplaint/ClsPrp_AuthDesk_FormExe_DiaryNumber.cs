...
{
    public class ClsPrp_AuthDesk_FormExe_DiaryNumber
    {
        public long ExecutionRegDiaryNumber_IndexID { get; set; }
        public long ExecutionRegDiaryNumber_ID { get; set; }
        [Display(Name = "Diary Number")]
        public string ExecutionRegDiaryNumber_Name { get; set; }
        public int ExecutionRegDiaryNumber_NameYear { get; set; }
        public long FormEXE_RelatedExecution_ID { get; set; }
        public string FormEXE_RelatedComplaint_Code { get; set; }
        ...
        public long RelatesComplaint_ComplaintAgainstType { get; set; }
        ...
        public List<ClsPrp_AuthDesk_FormExe_DiaryNumber> prpongoing { get; set; }
        public ClsPrp_AuthDesk_FormExe_DiaryNumber()
        {
            prpongoing = new List<ClsPrp_AuthDesk_FormExe_DiaryNumber>();
