...
{
    public class ClsPrp_AuthorityDesk_FormMN_AddMore_Complainant
    {
        public long AdditionComplainant_IndexID { get; set; }
        public long AdditionComplainant_ID { get; set; }
        public long? ComplainantApplicant_RelatedComplaint_ID { get; set; }
        public string ComplainantorApplicant_RelatedComplaint_Code { get; set; }
        ...
        public string Name_of_Complainant_or_Applicant { get; set; }
        ...
        public int IsDraftAllComplainants { get; set; }
        ...
        //[Display(Name = "Selected Complainant Name")]
        //public string SelectedComplainantName { get; set; }

        //[Display(Name = "Selected Respondant Name")]
        //public string SelectedRespondantName { get; set; }

        //[Display(Name = "Selected Advocate Name")]
        //public string SelectedAdvocateName { get; set; }
        public string CounselRepresentative { get; set; }

        public List<ClsPrp_AuthorityDesk_FormMN_AddMore_Complainant> FormMN_Complainant { get; set; }
        public List<ClsPrp_AuthorityDesk_FormMN_AddMore_Respondent> FormMN_Respondent { get; set; }
        public List<ClsPrp_Master_Advocates> MasterAdvocates { get; set; }

        public ClsPrp_AuthorityDesk_FormMN_AddMore_Complainant()
        {
            FormMN_Complainant = new List<ClsPrp_AuthorityDesk_FormMN_AddMore_Complainant>();
            FormMN_Respondent = new List<ClsPrp_AuthorityDesk_FormMN_AddMore_Respondent>();
