...
{
    public class Clsprp_Master_Complaint_InterimOrders
    {
        ...
        public List<Clsprp_Master_Complaint_InterimOrders> prpMasterDocs { get; set; }
        public Clsprp_Master_Complaint_InterimOrders()
        {
            prpMasterDocs = new List<Clsprp_Master_Complaint_InterimOrders>();
        }
    }
}