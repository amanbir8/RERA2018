...
{
    public class ClsMethod_ComplaintFormM_Fee
    {
        ...
        public List<ClsPrp_AuthorityDesk_FormM_Fee> Display_ComplaintFormM_Payment_ForDesk(Int64 ComplaintFormM_ID)
        {
            connection();
            List<ClsPrp_AuthorityDesk_FormM_Fee> ComplaintFormM_List = new List<ClsPrp_AuthorityDesk_FormM_Fee>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_FormM_Fee_ForDesk", con);
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ComplaintFormM_List.Add(
                       new ClsPrp_AuthorityDesk_FormM_Fee
                       {
        ...
        public List<ClsPrp_AuthorityDesk_FormM_Fee> Display_ComplaintFormM_PaymentByPRN_ForDesk(Int64 ComplaintFormM_PRNumber)
        {
            connection();
            List<ClsPrp_AuthorityDesk_FormM_Fee> ComplaintFormM_List = new List<ClsPrp_AuthorityDesk_FormM_Fee>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_FormM_FeeByPRN_ForDesk", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        #region EXECUTION
        public List<ClsPrp_AuthorityDesk_FormExe_Fee> Display_ComplaintFormExe_Payment_ForDesk(Int64 ComplaintForm_ID)
        {
            connection();
            List<ClsPrp_AuthorityDesk_FormExe_Fee> ComplaintFormM_List = new List<ClsPrp_AuthorityDesk_FormExe_Fee>();

            try
            {

                MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_FormExe_Fee_ForDesk", con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                {
                    ComplaintFormM_List.Add(
                           new ClsPrp_AuthorityDesk_FormExe_Fee
                           {
                               PaymentComplaint_IndexID = Convert.ToInt64(dr["PaymentComplaint_IndexID"]),
                               PaymentComplaint_ID = Convert.ToInt64(dr["PaymentComplaint_ID"]),
                               PaymentComplaint_RelatedComplainant_ID = Convert.ToInt64(dr["PaymentComplaint_RelatedComplainant_ID"]),
