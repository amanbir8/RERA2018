...
{
    public class ClsPrp_AuthDesk_FormN_CaseTransferDetails
    {
        public long CaseTransferN_IndexID { get; set; }
        public long CaseTransferN_ID { get; set; }
        public string CaseTransferN_RegDiaryNumber_IndexName { get; set; }
        public int CaseTransferN_RegDiaryNumber_NameYear { get; set; }
        [Display(Name = "Transfer Diary Number")]
        public string CaseTransferN_RegDiaryNumber_Name { get; set; }
        ...
        public List<ClsPrp_AuthDesk_FormN_CaseTransferDetails> prpongoing { get; set; }
        public ClsPrp_AuthDesk_FormN_CaseTransferDetails()
        {
            prpongoing = new List<ClsPrp_AuthDesk_FormN_CaseTransferDetails>();
