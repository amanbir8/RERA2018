...
{
    public class Clsprp_AuthorityDesk_FormM_Documents
    {
        ...
        public List<Clsprp_AuthorityDesk_FormM_Documents> prpFormM_Docs { get; set; }
        public Clsprp_AuthorityDesk_FormM_Documents()
        {
            prpFormM_Docs = new List<Clsprp_AuthorityDesk_FormM_Documents>();
        }
    }
}