...
{
    public class ClsPrp_AuthDesk_FormN_PreHearingInterimOrder
    {

        public long IntrimOrderFormN_IndexID { get; set; }
        public long IntrimOrderFormN_ID { get; set; }
        ...
        public List<ClsPrp_AuthDesk_FormN_PreHearingInterimOrder> prpongoing { get; set; }
        public ClsPrp_AuthDesk_FormN_PreHearingInterimOrder()
        {
            prpongoing = new List<ClsPrp_AuthDesk_FormN_PreHearingInterimOrder>();
        }
