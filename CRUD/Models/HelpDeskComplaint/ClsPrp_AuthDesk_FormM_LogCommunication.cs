...
{
    public class ClsPrp_AuthDesk_FormM_LogCommunication
    {
        ...
        public List<ClsPrp_AuthDesk_FormM_LogCommunication> prpongoing { get; set; }
        public ClsPrp_AuthDesk_FormM_LogCommunication()
        {
            prpongoing = new List<ClsPrp_AuthDesk_FormM_LogCommunication>();
        } 
