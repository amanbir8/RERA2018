...
{
    public class ClsMethod_AuthDesk_FormN_OrderJudgements
    {
        ...
        public List<ClsPrp_AuthDesk_FormN_OrderJudgements> Display_AuthDesk_ComplaintFormN_OrderJudgementDetailsByID(string mDiaryNumber, Int64 mComplaintID, string mComplaintType, Int32 mComplaintTransferFlag, string mComplaintTransferTypeOption, string mUserRole, string mUserName)
        {
            connection();
            List<ClsPrp_AuthDesk_FormN_OrderJudgements> ComplaintOrderlist = new List<ClsPrp_AuthDesk_FormN_OrderJudgements>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_Complaint_OrderJudgementContents_FormN_ByID", con);
        ...
        public List<ClsPrp_AuthDesk_FormN_OrderJudgements> Extract_AuthDesk_ComplaintFormN_CaseDetails_ByID(Int64 mComplaintFormN_ID, string mDiaryNumber_FormN, string mUserRole, string mUserName)
        {
            connection();
            List<ClsPrp_AuthDesk_FormN_OrderJudgements> CaseDetailslist = new List<ClsPrp_AuthDesk_FormN_OrderJudgements>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_AuthDesk_Complaint_FormN_OrderCaseDetails_ByID", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("p_ComplaintFormN_ID", mComplaintFormN_ID);
            cmd.Parameters.AddWithValue("p_DiaryNumber", mDiaryNumber_FormN);
            cmd.Parameters.AddWithValue("p_UserRole", mUserRole);
            cmd.Parameters.AddWithValue("p_UserName", mUserName);
            ...
            foreach (DataRow dr in dt.Rows)
            {
                CaseDetailslist.Add(
                       new ClsPrp_AuthDesk_FormN_OrderJudgements
                       {
                           ...
                           oRelated_CaseTransferN_IndexID = Convert.ToInt64(dr["pRelated_CaseTransferN_IndexID"]),
                           oRelated_CaseTransferN_ID = Convert.ToInt64(dr["pRelated_CaseTransferN_ID"]),
                           ...
                           oRelated_eCourt_CaseAllocationN_IndexID = Convert.ToInt64(dr["pRelated_eCourt_CaseAllocationN_IndexID"]),
                           oRelated_eCourt_CaseAllocationN_ID = Convert.ToInt64(dr["pRelated_eCourt_CaseAllocationN_ID"]),
