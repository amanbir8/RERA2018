...
{
    public class ClsPrp_AuthDesk_PreHearingBench_Master
    {
        ...
        public List<ClsPrp_AuthDesk_PreHearingBench_Master> prpongoing { get; set; }
        public ClsPrp_AuthDesk_PreHearingBench_Master()
        {
            prpongoing = new List<ClsPrp_AuthDesk_PreHearingBench_Master>();
        }        
    }
}