...
{
    public class Clsprp_AuthorityDesk_FormN_Documents
    {
        ...
        public List<Clsprp_AuthorityDesk_FormN_Documents> prpFormN_Docs { get; set; }
        public Clsprp_AuthorityDesk_FormN_Documents()
        {
            prpFormN_Docs = new List<Clsprp_AuthorityDesk_FormN_Documents>();
        }
    }
}