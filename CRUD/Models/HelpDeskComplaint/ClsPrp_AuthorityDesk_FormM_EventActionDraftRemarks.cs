...
{
    public class ClsPrp_AuthorityDesk_FormM_EventActionSaveAsDraftRemarks
    {

        public long ComplaintFormM_EventActionDraft_ID { get; set; }
        [Required]
        ...
        public List<ClsPrp_AuthorityDesk_FormM_EventActionSaveAsDraftRemarks> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_FormM_EventActionSaveAsDraftRemarks()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_FormM_EventActionSaveAsDraftRemarks>();
        }
