...
{
    public class ClsMethod_ComplaintFormN_Fee
    {
        ...
        public List<ClsPrp_AuthorityDesk_FormN_Fee> Display_ComplaintFormN_Payment_ForDesk(Int64 ComplaintFormN_ID)
        {
            connection();
            List<ClsPrp_AuthorityDesk_FormN_Fee> ComplaintFormN_List = new List<ClsPrp_AuthorityDesk_FormN_Fee>();
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ComplaintFormN_List.Add(
                       new ClsPrp_AuthorityDesk_FormN_Fee
                       {
        ...
        public List<ClsPrp_AuthorityDesk_FormN_Fee> Display_ComplaintFormN_PaymentByPRN_ForDesk(Int64 ComplaintFormN_PRNumber)
        {
            connection();
            List<ClsPrp_AuthorityDesk_FormN_Fee> ComplaintFormN_List = new List<ClsPrp_AuthorityDesk_FormN_Fee>();
