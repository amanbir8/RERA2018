...
{
    public class ClsPrp_AuthDesk_FormExe_SMTPsentlog
    {
        ...
        public List<ClsPrp_AuthDesk_FormExe_SMTPsentlog> prpongoing { get; set; }
        public ClsPrp_AuthDesk_FormExe_SMTPsentlog()
        {
            prpongoing = new List<ClsPrp_AuthDesk_FormExe_SMTPsentlog>();
        } 
