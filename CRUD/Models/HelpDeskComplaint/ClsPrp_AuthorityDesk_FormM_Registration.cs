...
{
    public class ClsPrp_AuthorityDesk_FormM_Registration
    {
        ...
        public ClsPrp_AuthorityDesk_FormM_Registration()
        {
            prpComplaintFormM = new List<ClsPrp_AuthorityDesk_FormM_Registration>();
        }
