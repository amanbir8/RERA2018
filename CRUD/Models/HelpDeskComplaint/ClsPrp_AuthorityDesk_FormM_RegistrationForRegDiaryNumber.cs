...
{
    public class ClsPrp_AuthorityDesk_FormM_RegistrationForRegDiaryNumber
    {
        ...
        public long yFormM_RelatedComplaint_ID { get; set; }
        public string yFormM_RelatedComplaint_Code { get; set; }
        ...
        public List<ClsPrp_AuthorityDesk_FormM_RegistrationForRegDiaryNumber> prpComplaintFormM { get; set; }
        public ClsPrp_AuthorityDesk_FormM_RegistrationForRegDiaryNumber()
        {
            prpComplaintFormM = new List<ClsPrp_AuthorityDesk_FormM_RegistrationForRegDiaryNumber>();
        }
