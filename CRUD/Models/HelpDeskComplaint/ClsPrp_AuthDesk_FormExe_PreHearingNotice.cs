...
{
    public class ClsPrp_AuthDesk_FormExe_PreHearingNotice
    {
        ...
        public List<ClsPrp_AuthDesk_FormExe_PreHearingNotice> prpongoingNotice { get; set; }
        public ClsPrp_AuthDesk_FormExe_PreHearingNotice()
        {
            prpongoingNotice = new List<ClsPrp_AuthDesk_FormExe_PreHearingNotice>();
