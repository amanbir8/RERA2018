...
{
    public class ClsPrp_AuthDesk_FormM_PreHearingDate
    {
        ...
        public List<ClsPrp_AuthDesk_FormM_PreHearingDate> prpongoing { get; set; }
        public ClsPrp_AuthDesk_FormM_PreHearingDate()
        {
            prpongoing = new List<ClsPrp_AuthDesk_FormM_PreHearingDate>();
