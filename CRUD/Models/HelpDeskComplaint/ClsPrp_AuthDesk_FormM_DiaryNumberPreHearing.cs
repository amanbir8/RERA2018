...
{
    public class ClsPrp_AuthDesk_FormM_DiaryNumberPreHearing
    {
        ...
        public List<ClsPrp_AuthDesk_FormM_DiaryNumberPreHearing> prpongoing { get; set; }
        public ClsPrp_AuthDesk_FormM_DiaryNumberPreHearing()
        {
            prpongoing = new List<ClsPrp_AuthDesk_FormM_DiaryNumberPreHearing>();
