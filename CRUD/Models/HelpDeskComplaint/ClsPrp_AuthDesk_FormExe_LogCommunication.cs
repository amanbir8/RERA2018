...
{
    public class ClsPrp_AuthDesk_FormExe_LogCommunication
    {
        ...
        public List<ClsPrp_AuthDesk_FormExe_LogCommunication> prpongoing { get; set; }
        public ClsPrp_AuthDesk_FormExe_LogCommunication()
        {
            prpongoing = new List<ClsPrp_AuthDesk_FormExe_LogCommunication>();
        } 
