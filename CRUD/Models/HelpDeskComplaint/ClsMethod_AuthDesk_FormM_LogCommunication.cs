...
{
    public class ClsMethod_AuthDesk_FormM_LogCommunication
    {
        ...
        public List<ClsPrp_AuthDesk_FormM_LogCommunication> Display_AuthDesk_ComplaintFormM_LogCommunicationByID(Int64 ComplaintFormM_ID, Int64 UserLog_ID)
        {
            connection();
            List<ClsPrp_AuthDesk_FormM_LogCommunication> UserLogList = new List<ClsPrp_AuthDesk_FormM_LogCommunication>();

            try
            {
                MySqlCommand cmd = new MySqlCommand("Display_Rera_AuthDesk_Complaint_FormM_LogCommunicationByID", con);
                ...
                {
                    UserLogList.Add(
                           new ClsPrp_AuthDesk_FormM_LogCommunication
                           {
        ...
        public List<ClsPrp_AuthDesk_FormExe_LogCommunication> Display_AuthDesk_ComplaintFormExe_LogCommunicationByID(Int64 ComplaintForm_ID, Int64 UserLog_ID)
        {
            connection();
            List<ClsPrp_AuthDesk_FormExe_LogCommunication> UserLogList = new List<ClsPrp_AuthDesk_FormExe_LogCommunication>();

            try
            {
                MySqlCommand cmd = new MySqlCommand("Display_Rera_AuthDesk_Complaint_FormExe_LogCommunicationByID", con);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                {
                    UserLogList.Add(
                           new ClsPrp_AuthDesk_FormExe_LogCommunication
                           {
                               CommUserLog_IndexID = Convert.ToInt64(dr["CommUserLog_IndexID"]),
                               Complaint_ID = Convert.ToInt64(dr["Complaint_ID"]),
                               Complaint_DiaryNumber = Convert.ToString(dr["Complaint_DiaryNumber"]),
