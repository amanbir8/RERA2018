...
{
    public class ClsPrp_AuthorityDesk_FormNEventLog
    {

        public long ComplaintFormN_EventAction_ID { get; set; }
        [Required]
        ...
        public List<ClsPrp_AuthorityDesk_FormNEventLog> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_FormNEventLog()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_FormNEventLog>();
