...
{
    public class ClsPrp_AuthorityDesk_FormN_EventActionSaveAsDraftRemarks
    {

        public long ComplaintFormN_EventActionDraft_ID { get; set; }
        [Required]
        ...
        public List<ClsPrp_AuthorityDesk_FormN_EventActionSaveAsDraftRemarks> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_FormN_EventActionSaveAsDraftRemarks()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_FormN_EventActionSaveAsDraftRemarks>();
        }
