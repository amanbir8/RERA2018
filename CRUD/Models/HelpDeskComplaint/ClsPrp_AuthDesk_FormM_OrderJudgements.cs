...
{
    public class ClsPrp_AuthDesk_FormM_OrderJudgements
    {
        ...
        public long oOrderDesc_formM_eCourtIndexID { get; set; }
        public long oOrderDesc_formM_eCourtID { get; set; }
        [Display(Name = "Serial Number")]
        ...
        public long oRelated_OrderJudgementByAuthority_IndexID { get; set; }
        public long oRelated_OrderJudgementByAuthority_ID { get; set; }
        ...
        public long oRelated_CaseTransfer_IndexID { get; set; }
        public long oRelated_CaseTransfer_ID { get; set; }

        public long oRelated_PreHearingDate_IndexID { get; set; }
        public long oRelated_PreHearingDate_ID { get; set; }

        public long oRelated_eCourt_CaseAllocation_IndexID { get; set; }
        public long oRelated_eCourt_CaseAllocation_ID { get; set; }
        ...
        public List<ClsPrp_AuthDesk_FormM_OrderJudgements> prpongoing { get; set; }
        public ClsPrp_AuthDesk_FormM_OrderJudgements()
        {
            prpongoing = new List<ClsPrp_AuthDesk_FormM_OrderJudgements>();
        }

        public List<ClsPrp_AuthDesk_FormM_OrderJudgements> prpOrderJudgements { get; set; }
