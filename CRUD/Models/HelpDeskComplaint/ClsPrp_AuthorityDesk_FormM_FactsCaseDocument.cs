...
{
    public class ClsPrp_AuthorityDesk_FormM_FactsCaseDocument
    {
        ...
        public List<ClsPrp_AuthorityDesk_FormM_FactsCaseDocument> prpAuthFormM_FactsCase_Docs { get; set; }
        public ClsPrp_AuthorityDesk_FormM_FactsCaseDocument()
        {
            prpAuthFormM_FactsCase_Docs = new List<ClsPrp_AuthorityDesk_FormM_FactsCaseDocument>();
        }
    }
}