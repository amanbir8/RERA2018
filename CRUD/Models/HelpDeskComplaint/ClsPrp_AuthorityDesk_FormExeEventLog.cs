...
{
    public class ClsPrp_AuthorityDesk_FormExeEventLog
    {

        public long ComplaintFormexe_EventAction_ID { get; set; }
        [Required]
        ...
        public long Related_Complaint_ID { get; set; }        
        ...
        public List<ClsPrp_AuthorityDesk_FormExeEventLog> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_FormExeEventLog()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_FormExeEventLog>();
