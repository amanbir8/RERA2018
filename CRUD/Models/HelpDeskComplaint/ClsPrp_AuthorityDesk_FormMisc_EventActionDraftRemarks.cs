...
{
    public class ClsPrp_AuthorityDesk_FormMisc_EventActionSaveAsDraftRemarks
    {

        public long ComplaintFormMisc_EventActionDraft_ID { get; set; }
        [Required]
        ...
        public string IdentifiedBy_UserId { get; set; }
        public string IdentifiedBy_RoleId { get; set; }
        public string IdentifiedBy_FormType { get; set; }
        ...
        public string ComplainantRERAnumber { get; set; }
        [Display(Name = "Respondant Name")]
        public string RespondantName { get; set; }
        [Display(Name = "Last Modified On")]
        [DisplayFormat(DataFormatString = "{0:dd-MMM-yyyy}", ApplyFormatInEditMode = true)]
        public DateTime? ComplaintFormLastModifiedOn { get; set; }
        ...
        public List<ClsPrp_AuthorityDesk_FormMisc_EventActionSaveAsDraftRemarks> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_FormMisc_EventActionSaveAsDraftRemarks()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_FormMisc_EventActionSaveAsDraftRemarks>();
        }
