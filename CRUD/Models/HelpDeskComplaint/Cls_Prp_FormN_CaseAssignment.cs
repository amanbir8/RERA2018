...
{
    public class Cls_Prp_FormN_CaseAssignment
    {
        public long InstitutionFormN_IndexID { get; set; }
        public long InstitutionFormN_ID { get; set; }
        public string InstitutionFormN_Code { get; set; }
        ...
        public List<Cls_Prp_FormN_CaseAssignment> prpongoing { get; set; }
        public Cls_Prp_FormN_CaseAssignment()
        {
            prpongoing = new List<Cls_Prp_FormN_CaseAssignment>();

        }
        public List<ClsPrp_AuthDesk_PreHearingBench_Master> PreHearingBenchMaster { get; set; }

        public List<BenchMasters> OnlineBenchMaster { get; set; }
        public long onlineBench_ID { get; set; }
        public string onlineBenchName { get; set; }
    }

    public class BenchMasters
    {
        public long onlineBench_ID { get; set; }
        public string onlineBenchName { get; set; }
    }
