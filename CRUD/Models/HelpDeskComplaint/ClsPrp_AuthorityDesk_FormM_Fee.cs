...
{
    public class ClsPrp_AuthorityDesk_FormM_Fee
    {
        ...
        public List<ClsPrp_AuthorityDesk_FormM_Fee> prpComplaintFormM_Fee { get; set; }
        public ClsPrp_AuthorityDesk_FormM_Fee()
        {
            prpComplaintFormM_Fee = new List<ClsPrp_AuthorityDesk_FormM_Fee>();
        }

        public List<ClsPrp_AuthorityDesk_FormM_Registration> prpComplaintFormM { get; set; }
    }
}