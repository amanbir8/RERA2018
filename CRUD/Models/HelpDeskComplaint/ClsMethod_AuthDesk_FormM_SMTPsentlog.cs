...
{
    public class ClsMethod_AuthDesk_FormM_SMTPsentlog
    {
        ...
        public bool Add_ComplaintFormM_SMTPsentlog(ClsPrp_AuthDesk_FormM_SMTPsentlog smodel, string UserName)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_insert_tbl_rera_complaint_formm_smtpsentlog", con);
        ...
        public bool Add_ComplaintFormExe_SMTPsentlog(ClsPrp_AuthDesk_FormM_SMTPsentlog smodel, string UserName)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_insert_tbl_rera_complaint_formExe_smtpsentlog", con);
            cmd.CommandType = CommandType.StoredProcedure;
