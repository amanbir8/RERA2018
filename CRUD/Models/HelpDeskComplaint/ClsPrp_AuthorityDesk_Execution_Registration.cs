...
{
    public class ClsPrp_AuthorityDesk_Execution_Registration
    {
        ...
        public List<ClsPrp_AuthorityDesk_Execution_Registration> ExecutionFormI { get; set; }
        public ClsPrp_AuthorityDesk_Execution_Registration()
        {
            ExecutionFormI = new List<ClsPrp_AuthorityDesk_Execution_Registration>();
        }
