...
{
    public class ClsPrp_AuthorityDesk_FormMEventLog
    {

        public long ComplaintFormM_EventAction_ID { get; set; }
        [Required]
        ...
        public List<ClsPrp_AuthorityDesk_FormMEventLog> prpongoing { get; set; }
        public ClsPrp_AuthorityDesk_FormMEventLog()
        {
            prpongoing = new List<ClsPrp_AuthorityDesk_FormMEventLog>();
