...
{
    public class ClsPrp_AuthorityDesk_FormN_Registration
    {
        ...
        public List<ClsPrp_AuthorityDesk_FormN_Registration> prpComplaintFormN { get; set; }
        public ClsPrp_AuthorityDesk_FormN_Registration()
        {
            prpComplaintFormN = new List<ClsPrp_AuthorityDesk_FormN_Registration>();
        }
