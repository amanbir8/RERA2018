...
{
    public class ClsPrp_AuthorityDesk_FormN_FactsCaseDocument
    {
        public long FactsCaseDocument_IndexID { get; set; }
        public long FactsCaseDocument_ID { get; set; }
        public long ComplainantApplicant_RelatedComplaintN_ID { get; set; }
        public string ComplainantApplicant_RelatedComplaintN_Code { get; set; }
        ...
        public List<ClsPrp_AuthorityDesk_FormN_FactsCaseDocument> prpAuthFormN_FactsCase_Docs { get; set; }
        public ClsPrp_AuthorityDesk_FormN_FactsCaseDocument()
        {
            prpAuthFormN_FactsCase_Docs = new List<ClsPrp_AuthorityDesk_FormN_FactsCaseDocument>();
        }
    }
}