...
{
    public class ClsPrp_AuthorityDesk_FormExe_Fee
    {
        ...
        public List<ClsPrp_AuthorityDesk_FormExe_Fee> prpComplaintFormExe_Fee { get; set; }
        public ClsPrp_AuthorityDesk_FormExe_Fee()
        {
            prpComplaintFormExe_Fee = new List<ClsPrp_AuthorityDesk_FormExe_Fee>();
        }

        public List<ClsPrp_AuthorityDesk_Execution_Registration> prpComplaintFormExe { get; set; }
    }
}