...
{
    public class ClsPrp_AuthDesk_FormM_PreHearingNotice
    {
        ...
        public List<ClsPrp_AuthDesk_FormM_PreHearingNotice> prpongoingNotice { get; set; }
        public ClsPrp_AuthDesk_FormM_PreHearingNotice()
        {
            prpongoingNotice = new List<ClsPrp_AuthDesk_FormM_PreHearingNotice>();
