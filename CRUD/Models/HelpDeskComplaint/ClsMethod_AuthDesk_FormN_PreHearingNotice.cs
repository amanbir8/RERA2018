...
{
    public class ClsMethod_AuthDesk_FormN_PreHearingNotice
    {
        ...
        public List<ClsPrp_AuthDesk_FormN_PreHearingNotice> Display_AuthDesk_ComplaintFormN_PreHearingNoticeByID(Int64 ComplaintFormN_ID, Int64 PreHearingNotice_ID)
        {
            connection();
            List<ClsPrp_AuthDesk_FormN_PreHearingNotice> ProjectFivelist1 = new List<ClsPrp_AuthDesk_FormN_PreHearingNotice>();
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ProjectFivelist1.Add(
                       new ClsPrp_AuthDesk_FormN_PreHearingNotice
                       {
