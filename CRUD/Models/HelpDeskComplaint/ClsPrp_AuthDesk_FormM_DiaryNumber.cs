...
{
    public class ClsPrp_AuthDesk_FormM_DiaryNumber
    {
        ...
        public List<ClsPrp_AuthDesk_FormM_DiaryNumber> prpongoing { get; set; }
        public ClsPrp_AuthDesk_FormM_DiaryNumber()
        {
            prpongoing = new List<ClsPrp_AuthDesk_FormM_DiaryNumber>();
