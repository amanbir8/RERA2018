...
{
    public class ClsPrp_AuthDesk_FormM_SMTPsentlog
    {
        ...
        public List<ClsPrp_AuthDesk_FormM_SMTPsentlog> prpongoing { get; set; }
        public ClsPrp_AuthDesk_FormM_SMTPsentlog()
        {
            prpongoing = new List<ClsPrp_AuthDesk_FormM_SMTPsentlog>();
        } 
