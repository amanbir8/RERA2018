...
{
    public class ClsMethod_AuthDesk_FormN_CaseTransferDetails
    {
        ...
        public bool Add_ComplaintFormN_CaseTransferDetails(ClsPrp_AuthDesk_FormN_CaseTransferDetails smodel, string User_ID, string User_Name, Int64 ComplaintFormN_ID, string FormN_DiaryNumber)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_insert_tbl_rera_complaint_formN_CaseTransferDetails", con);
            cmd.CommandType = CommandType.StoredProcedure;

            DateTime dtvalue = new DateTime(0001, 1, 1);

            #region Parameters
            cmd.Parameters.AddWithValue("p_CaseTransferN_IndexID", smodel.CaseTransferN_IndexID);
            cmd.Parameters.AddWithValue("p_CaseTransferN_ID", smodel.CaseTransferN_ID);
            cmd.Parameters.AddWithValue("p_CaseTransferN_RegDiaryNumber_IndexName", String.IsNullOrEmpty(smodel.CaseTransferN_RegDiaryNumber_IndexName) ? "" : smodel.CaseTransferN_RegDiaryNumber_IndexName);
            cmd.Parameters.AddWithValue("p_CaseTransferN_RegDiaryNumber_NameYear", smodel.CaseTransferN_RegDiaryNumber_NameYear);
            cmd.Parameters.AddWithValue("p_CaseTransferN_RegDiaryNumber_Name", String.IsNullOrEmpty(smodel.CaseTransferN_RegDiaryNumber_Name) ? "" : smodel.CaseTransferN_RegDiaryNumber_Name);

            cmd.Parameters.AddWithValue("p_ComplainantApplicant_RelatedComplaint_ID", ComplaintFormN_ID);
        ...
        public bool Update_ComplaintFormN_CaseTransferDetails(ClsPrp_AuthDesk_FormN_CaseTransferDetails smodel, string User_ID, string User_Name)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("usp_update_tbl_rera_complaint_formn_CaseTransferDetails", con);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public List<ClsPrp_AuthDesk_FormN_CaseTransferDetails> Display_AuthDesk_ComplaintFormN_CaseTransferDetails(Int64 ComplaintFormN_ID, string UserRole, string UserName)
        {
            connection();
            List<ClsPrp_AuthDesk_FormN_CaseTransferDetails> CaseTransferlist = new List<ClsPrp_AuthDesk_FormN_CaseTransferDetails>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_AuthDesk_Complaint_FormN_CaseTransferDetails", con);
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            foreach (DataRow dr in dt.Rows)
            {
                CaseTransferlist.Add(
                       new ClsPrp_AuthDesk_FormN_CaseTransferDetails
                       {
                           CaseTransferN_IndexID = Convert.ToInt64(dr["CaseTransferN_IndexID"]),
                           CaseTransferN_ID = Convert.ToInt64(dr["CaseTransferN_ID"]),
                           CaseTransferN_RegDiaryNumber_IndexName = Convert.ToString(dr["CaseTransferN_RegDiaryNumber_IndexName"]),
                           CaseTransferN_RegDiaryNumber_NameYear = Convert.ToInt32(dr["CaseTransferN_RegDiaryNumber_NameYear"]),
                           CaseTransferN_RegDiaryNumber_Name = Convert.ToString(dr["CaseTransferN_RegDiaryNumber_Name"]),
        ...
        public List<ClsPrp_AuthDesk_FormN_CaseTransferDetails> Display_AuthDesk_ComplaintFormN_CaseTransferDetailsByID(Int64 ComplaintFormN_ID, Int64 CaseTransferN_IndexID, Int64 CaseTransferN_ID, string UserRole, string UserName)
        {
            connection();
            List<ClsPrp_AuthDesk_FormN_CaseTransferDetails> CaseTransferlist = new List<ClsPrp_AuthDesk_FormN_CaseTransferDetails>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_AuthDesk_Complaint_FormN_CaseTransferDetailsByID", con);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("p_ComplaintFormN_ID", ComplaintFormN_ID);
            cmd.Parameters.AddWithValue("p_CaseTransferN_IndexID", CaseTransferN_IndexID);
            cmd.Parameters.AddWithValue("p_CaseTransferN_ID", CaseTransferN_ID);
            cmd.Parameters.AddWithValue("p_UserRole", UserRole);
            cmd.Parameters.AddWithValue("p_UserName", UserName);
        ...
        public bool Delete_AuthDesk_ComplaintFormN_CaseTransferDetailsByID(Int64? mComplaintFormN_ID, Int64? mCaseTransferN_IndexID, string mUserRole, string mUserName)
        {
            connection();
            MySqlCommand cmd = new MySqlCommand("Delete_Rera_Complaint_FormN_CaseTransferDetailsByID", con);
            cmd.CommandType = CommandType.StoredProcedure;

            cmd.Parameters.AddWithValue("p_ComplaintFormN_ID", mComplaintFormN_ID);
            cmd.Parameters.AddWithValue("p_CaseTransferN_IndexID", mCaseTransferN_IndexID);
        ...
        public int extractFormNCaseTransferDetails_Isdraftvalue_FromEventLog(Int64 mComplaintFormN_ID)
        {
            connection();
            ...
            try
            {
                ...
                cmd.CommandText = "Display_Rera_Complaint_FormN_CaseTransferIsdraft_FromDiaryNumber";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Connection = con;
                cmd.Parameters.AddWithValue("p_ComplaintFormN_ID", mComplaintFormN_ID);
                cmd.Parameters.AddWithValue("p_FormNcode", "0");                
                cmd.ExecuteNonQuery();
