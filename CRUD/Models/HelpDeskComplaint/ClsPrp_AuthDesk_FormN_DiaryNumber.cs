...
{
    public class ClsPrp_AuthDesk_FormN_DiaryNumber
    {
        ...
        public List<ClsPrp_AuthDesk_FormN_DiaryNumber> prpongoing { get; set; }
        public ClsPrp_AuthDesk_FormN_DiaryNumber()
        {
            prpongoing = new List<ClsPrp_AuthDesk_FormN_DiaryNumber>();
