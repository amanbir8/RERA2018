...
{
    public class ClsPrp_AuthorityDesk_FormN_Fee
    {
        ...
        public List<ClsPrp_AuthorityDesk_FormN_Fee> prpComplaintFormN_Fee { get; set; }
        public ClsPrp_AuthorityDesk_FormN_Fee()
        {
            prpComplaintFormN_Fee = new List<ClsPrp_AuthorityDesk_FormN_Fee>();
        }
