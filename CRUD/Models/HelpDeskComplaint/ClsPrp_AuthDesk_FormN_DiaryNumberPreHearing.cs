...
{
    public class ClsPrp_AuthDesk_FormN_DiaryNumberPreHearing
    {
        ...
        public List<ClsPrp_AuthDesk_FormN_DiaryNumberPreHearing> prpongoing { get; set; }
        public ClsPrp_AuthDesk_FormN_DiaryNumberPreHearing()
        {
            prpongoing = new List<ClsPrp_AuthDesk_FormN_DiaryNumberPreHearing>();
