...
{
    public class ClsPrp_ComplaintExecutionForm_PaymentIntegration
    {
        ...
        public string PG_Shipping_Aemail { get; set; }
        ...
        public List<ClsPrp_ComplaintExecutionForm_PaymentIntegration> ComplaintExecutionFormstepII { get; set; }
        public ClsPrp_ComplaintExecutionForm_PaymentIntegration()
        {
            ComplaintExecutionFormstepII = new List<ClsPrp_ComplaintExecutionForm_PaymentIntegration>();
        }
        ...
        public List<ClsPrp_ExecutionApplication> ComplaintExecutionForm_ApplicationStepI { get; set; }
        public List<ClsPrp_ComplaintProfile> ComplainantFormM_UserProfile { get; set; }
    }
}