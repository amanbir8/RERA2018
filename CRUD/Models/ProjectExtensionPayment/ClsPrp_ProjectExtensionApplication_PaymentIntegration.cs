...
{
    public class ClsPrp_ProjectExtensionApplication_PaymentIntegration
    {
        public long PaymentRefNumberProjectPm_IndexID { get; set; }
        ...
        [Display(Name = "Status")]
        public string ProjectPm_BriefSummary { get; set; }
        ...
        public List<ClsPrp_ProjectExtensionApplication_PaymentIntegration> ProjectExtensionPayment { get; set; }
        public ClsPrp_ProjectExtensionApplication_PaymentIntegration()
        {
            ProjectExtensionPayment = new List<ClsPrp_ProjectExtensionApplication_PaymentIntegration>();
        }

        public List<ClsPrp_StateMaster> stateMaster { get; set; }        
        public List<ClsPrp_DistrictMaster> districtMaster { get; set; }

        public List<ClsPrp_ProjectExtensionApplication_Registration> ProjectExtensionApplication_Registration { get; set; }
    }
}