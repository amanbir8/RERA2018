...
namespace CRUD.Models.ProjectExtensionPayment
{
    public class ClsPrp_ProjectExtensionApp_Payment
    {
        ...
        public long RelatedExtensionForm_PromoterID { get; set; }
        public string RelatedExtensionForm_ProjectCode { get; set; }
        public string RelatedExtensionForm_PromoterCode { get; set; }
        ...
        public List<ClsPrp_ProjectExtensionApp_Payment> ProjectExtensionPayment { get; set; }
        public ClsPrp_ProjectExtensionApp_Payment()
        {
            ProjectExtensionPayment = new List<ClsPrp_ProjectExtensionApp_Payment>();
        }
    }
}