...
{
    public class ClsMethodMIS_FormNcomplaintReminderEmailsDetails
    {
        ...
        public List<ClsprpMIS_FormNInCompleteRemindersSchedulerEmails> Display_AuthDesk_MIS_FormNcomplaintSchedulerReminderEmailsDetails_ByID(Int64 Complaint_ID, Int64 Complaint_Code, string Complaint_DNumber, string UserID_Role)
        {
            connection();
            List<ClsprpMIS_FormNInCompleteRemindersSchedulerEmails> Complaintlist = new List<ClsprpMIS_FormNInCompleteRemindersSchedulerEmails>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_MIS_ComplaintReminderEmailSchedulerDetails_FormN", con);
            ...
            {
                Complaintlist.Add(
                       new ClsprpMIS_FormNInCompleteRemindersSchedulerEmails
                       {
                           FormN_Reminder_IndexID = Convert.ToInt64(dr["FormN_Reminder_IndexID"]),
                           FormN_Reminder_ID = Convert.ToInt64(dr["FormN_Reminder_ID"]),
