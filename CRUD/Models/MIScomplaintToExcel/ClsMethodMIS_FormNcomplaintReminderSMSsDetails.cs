...
{
    public class ClsMethodMIS_FormNcomplaintReminderSMSsDetails
    {
        ...
        public List<ClsprpMIS_FormNInCompleteRemindersSchedulerSMSgateway> Display_AuthDesk_MIS_FormNcomplaintSchedulerReminderSMSsDetails_ByID(Int64 Complaint_ID, Int64 Complaint_Code, string Complaint_DNumber, string UserID_Role)
        {
            connection();
            List<ClsprpMIS_FormNInCompleteRemindersSchedulerSMSgateway> Complaintlist = new List<ClsprpMIS_FormNInCompleteRemindersSchedulerSMSgateway>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_MIS_ComplaintReminderSMSsSchedulerDetails_FormN", con);
            ...
            {
                Complaintlist.Add(
                       new ClsprpMIS_FormNInCompleteRemindersSchedulerSMSgateway
                       {
                           FormN_ReminderSMS_IndexID = Convert.ToInt64(dr["FormN_ReminderSMS_IndexID"]),
                           FormN_ReminderSMS_ID = Convert.ToInt64(dr["FormN_ReminderSMS_ID"]),
                           RelatedComplaintFormN_ID = Convert.ToInt64(dr["RelatedComplaintFormN_ID"]),
                           ...
                           RelatedComplaintFormN_DiaryNumber = Convert.ToString(dr["RelatedComplaintFormN_DiaryNumber"]),
                           ApplicationDateFormN = Convert.ToDateTime(dr["ApplicationDateFormN"]),
