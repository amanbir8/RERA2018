...
{
    public class ClsprpMIS_FormNInCompleteRemindersSchedulerSMSgateway
    {
        public long FormN_ReminderSMS_IndexID { get; set; }
        public long FormN_ReminderSMS_ID { get; set; }
        ...
        public List<ClsprpMIS_FormNInCompleteRemindersSchedulerSMSgateway> prpongoing { get; set; }
        public ClsprpMIS_FormNInCompleteRemindersSchedulerSMSgateway()
        {
            prpongoing = new List<ClsprpMIS_FormNInCompleteRemindersSchedulerSMSgateway>();
        }
    }
}