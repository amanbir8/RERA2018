...
{
    public class ClsprpMIS_FormNInCompleteRemindersSchedulerEmails
    {
        public long FormN_Reminder_IndexID { get; set; }
        public long FormN_Reminder_ID { get; set; }
        public long RelatedComplaintFormN_ID { get; set; }
        ...
        public string RelatedComplaintFormN_DiaryNumber { get; set; }
        [Display(Name = "Date of Filing")]
        [DisplayFormat(DataFormatString = "{0:dd-MMM-yyyy}", ApplyFormatInEditMode = true)]
        public DateTime? ApplicationDateFormN { get; set; }
        ...
        public List<ClsprpMIS_FormNInCompleteRemindersSchedulerEmails> prpongoing { get; set; }
        public ClsprpMIS_FormNInCompleteRemindersSchedulerEmails()
        {
            prpongoing = new List<ClsprpMIS_FormNInCompleteRemindersSchedulerEmails>();
        }
        
        public List<ClsprpMIS_FormNInCompleteRemindersSchedulerSMSgateway> prpSchedulerSMSgateway { get; set; }
    }
}