...
{
    public class ClsprpMIS_FormMInCompleteRemindersSchedulerSMSgateway
    {
        public long FormM_ReminderSMS_IndexID { get; set; }
        public long FormM_ReminderSMS_ID { get; set; }
        ...
        public long ProjectReminderSMS_IndexID { get; set; }
        public long ProjectReminderSMS_ID { get; set; }
        ...
        public List<ClsprpMIS_FormMInCompleteRemindersSchedulerSMSgateway> prpongoing { get; set; }
        public ClsprpMIS_FormMInCompleteRemindersSchedulerSMSgateway()
        {
            prpongoing = new List<ClsprpMIS_FormMInCompleteRemindersSchedulerSMSgateway>();
        }
    }
}