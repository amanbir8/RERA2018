...
{
    public class ClsMethodMIS_FormMcomplaintReminderSMSsDetails
    {
        ...
        public List<ClsprpMIS_FormMInCompleteRemindersSchedulerSMSgateway> Display_AuthDesk_MIS_FormMcomplaintSchedulerReminderSMSsDetails_ByID(Int64 Complaint_ID, Int64 Complaint_Code, string Complaint_DNumber, string UserID_Role)
        {
            connection();
            List<ClsprpMIS_FormMInCompleteRemindersSchedulerSMSgateway> Complaintlist = new List<ClsprpMIS_FormMInCompleteRemindersSchedulerSMSgateway>();

            MySqlCommand cmd = new MySqlCommand("Display_Rera_MIS_ComplaintReminderSMSsSchedulerDetails_FormM", con);
            ...
            {
                Complaintlist.Add(
                       new ClsprpMIS_FormMInCompleteRemindersSchedulerSMSgateway
                       {
                           FormM_ReminderSMS_IndexID = Convert.ToInt64(dr["FormM_ReminderSMS_IndexID"]),
                           FormM_ReminderSMS_ID = Convert.ToInt64(dr["FormM_ReminderSMS_ID"]),
